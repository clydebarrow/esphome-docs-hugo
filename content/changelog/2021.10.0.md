...
The new documentation is here at [/components/esp32]({{< ref "/components/esp32" >}}).
...
If you intend on creating and distributing devices preinstalled with ESPHome, check out [/guides/creators]({{< ref "/guides/creators" >}})
...
- [Modbus Controller ]({{< relref "/components/modbus_controller" >}})
- [Sensors ]({{< relref "/components/sensor/modbus_controller" >}})
- [Binary Sensors ]({{< relref "/components/binary_sensor/modbus_controller" >}})
- [Text Sensors ]({{< relref "/components/text_sensor/modbus_controller" >}})
- [Numbers ]({{< relref "/components/number/modbus_controller" >}})
- [Switches ]({{< relref "/components/switch/modbus_controller" >}})
- [Outputs ]({{< relref "/components/output/modbus_controller" >}})

## Text Sensor filters

`text_sensors` now have `filters` that allow you to do string manipulation before the value is
given to the frontend. Check out the [Text Sensor Filters]({{< ref "components/text_sensor/_index#text_sensor-filters" >}}).
...
There is new [Graph Component]({{< ref "components/graph#display-graphs" >}}) building functions for displays that will allow you to
