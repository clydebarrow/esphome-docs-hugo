...
This release brings [buttons ]({{< relref "/components/button/index" >}}) from Home Assistant. Many times there have been questions on how to simply trigger automations
...
sets the direction on the secondary MCU. See the [documentation ]({{< relref "/components/cover/tuya" >}}) for the new
