...
ESPHome devices can now create [Select]({{< relref "/components/select/index" >}}) entities in Home Assistant. This allows you to
...
:ghuser:`kbx81` Has made a few changes to the [thermostat]({{< relref "/components/climate/thermostat" >}}) climate platform
...
There is a change with the [Anova BLE Souve]({{< relref "/components/climate/anova" >}}) climate platform that has a new **required**
