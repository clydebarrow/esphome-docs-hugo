...
It was brought to our attention by :ghuser:`andir` that the [/components/web_server]({{< ref "/components/web_server" >}}) had a vulnerability in that
...
[Packages<config-git_packages>]({{< ref "#Packages<config-git_packages>" >}}) have been extended to allow loading (multiple) YAML file(s) from a git repo.
...
quite a few upgrades. Check the docs for the new features. [/components/climate/midea]({{< ref "/components/climate/midea" >}})

## SDM Meters

[SDM Meters]({{< relref "/components/sensor/sdm_meter" >}}) have been fixed to use kWh instead of Wh
...
- Move web_server auth to web_server_base [be965a6](https://github.com/esphome/esphome/commit/be965a60eba6bb769e2a5afdbc8eed132f077a59)  by :ghuser:`OttoWinter`
