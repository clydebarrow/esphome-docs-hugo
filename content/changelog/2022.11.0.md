...
ESPHome will now preserve any credentials entered via the [/components/improv_serial]({{< ref "/components/improv_serial" >}}), [/components/captive_portal]({{< ref "/components/captive_portal" >}})
or [/components/esp32_improv]({{< ref "/components/esp32_improv" >}}) components after an OTA update of the firmeware is done. It is possible they can survive
