...
issues. See the [documentation ]({{< relref "/components/light/fastled" >}}) for information on how
...
Please see the [documentation ]({{< relref "/components/debug" >}}) page for the new way to configure them.
