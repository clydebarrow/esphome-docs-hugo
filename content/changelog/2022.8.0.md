...
and keep those plants and veggies thriving. Check out the docs at [/components/sprinkler]({{< ref "/components/sprinkler" >}}).

## ST7789V

The [/components/display/st7789v]({{< ref "/components/display/st7789v" >}}) display platform has had an update which adds a `model` configuration option.
...
the [/components/sensor/total_daily_energy]({{< ref "/components/sensor/total_daily_energy" >}}) and [/components/sensor/integration]({{< ref "/components/sensor/integration" >}}).
