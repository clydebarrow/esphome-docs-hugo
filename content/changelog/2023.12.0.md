...
Following on from the previous [/components/display_menu/lcd_menu]({{< ref "/components/display_menu/lcd_menu" >}}) that was only for LCD displays,
there is now a new [/components/display_menu/graphical_display_menu]({{< ref "/components/display_menu/graphical_display_menu" >}}) that can be used with any
...
duplicate pin definitions. See the [config-pin_schema]({{< ref "guides/configuration-types#config-pin_schema" >}}) for details.
