...
Following on from last months release adding [microphones ]({{< relref "/components/microphone/index" >}}),
this release adds [speaker ]({{< relref "/components/speaker/index" >}}) support!

These new changes allows the [/components/voice_assistant]({{< ref "/components/voice_assistant" >}}) to request the raw audio
stream response from Home Assistant to playback without using a full [/components/media_player/index]({{< ref "/components/media_player/index" >}}).
...
See the [microphone documentation ]({{< relref "/components/microphone/i2s_audio" >}}) for the configuration details,
