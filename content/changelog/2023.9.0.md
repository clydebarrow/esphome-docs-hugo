...
[LibreTiny ]({{< relref "/components/libretiny" >}}) is a platform for the RTL87xx and BK72xx family of chips. ESPHome leverages
...
[WireGuard ]({{< relref "/components/wireguard" >}}) is a new component that allows you to connect to a |wireguard| Peer.

## LED Strips

Following on from the previously added [/components/light/esp32_rmt_led_strip]({{< ref "/components/light/esp32_rmt_led_strip" >}}), we now have
[SPI LED Strips ]({{< relref "/components/light/spi_led_strip" >}}). These are replacement components for
[/components/light/fastled]({{< ref "/components/light/fastled" >}}) and [/components/light/neopixelbus]({{< ref "/components/light/neopixelbus" >}}) that
