...
For those that use the [/components/web_server]({{< ref "/components/web_server" >}}) with version 3, there is a new
...
Please see [config-webserver-sorting]({{< ref "components/web_server#config-webserver-sorting" >}}) for the latest documentation on these features.
...
The [/components/sensor/cse7766]({{< ref "/components/sensor/cse7766" >}}) now requires even parity in configuration. There are some chips that work without `EVEN`,
