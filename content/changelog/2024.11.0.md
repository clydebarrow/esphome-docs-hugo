...
This release brings [/components/opentherm]({{< ref "/components/opentherm" >}}) support to ESPHome. Please see the
[documentation ]({{< relref "/components/opentherm" >}}) for detailed information about it and how to use it.
