...
See the [component documentation ]({{< relref "/components/micro_wake_word" >}}) for details on how to use it.
...
to continue using the BME280 over I2C. See the [component documentation ]({{< relref "/components/sensor/bme280" >}}) for the latest configuration variables.
