...
The [documentation ]({{< relref "/components/lvgl/index" >}}) is very extensive and hopefully we see
some awesome dashboards being made with it.

## Online Image

:ghuser:`guillempages` created a new [online_image ]({{< relref "/components/online_image" >}}) component that allows your ESPHome device to download
