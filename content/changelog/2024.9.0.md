...
The first is the [UDP Component ]({{< relref "/components/udp" >}}) which allows direct communication between ESPHome
...
Next is the [StatsD Component ]({{< relref "/components/statsd" >}}) which allows you to send sensor data
