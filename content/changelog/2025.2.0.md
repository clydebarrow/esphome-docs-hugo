...
encourage all developers to migrate their custom components to [/components/external_components]({{< ref "/components/external_components" >}}). Please see
...
difference, but this change could result in some issues, particularly for [/components/external_components]({{< ref "/components/external_components" >}}). You
...
[/projects/index]({{< ref "/projects/index" >}}) web installer. If you have "taken control" of or "adopted" your S3-Box, we strongly recommend
...
[/components/voice_assistant]({{< ref "/components/voice_assistant" >}}). These components extend our work to help you create the ultimate personal voice
assistant hardware.

The new [speaker media player ]({{< relref "/components/media_player/speaker" >}}) component adds several features for building
a well-rounded audio device. It supports playing two different streams of audio: one for announcements and another
for music.

The new [mixer speaker ]({{< relref "/components/speaker/mixer" >}}) component lets you combine the two streams. The mixer
...
configuration variable in [/components/image]({{< ref "/components/image" >}}) and related components was renamed to `transparency` and changed
from a boolean to an enum; in addition, the `type` configuration variable is now mandatory. See the
[/components/image]({{< ref "/components/image" >}}) documentation for more detail.
...
Finally, the [/components/online_image]({{< ref "/components/online_image" >}}) was updated to add support for both BMP and JPEG image formats.

## ILI9XXX Display Component

There are two changes to the [/components/display/ili9xxx]({{< ref "/components/display/ili9xxx" >}}) component. Previously the component automatically loaded
...
- [2024.12.0]({{< ref "2024.12.0/" >}})
- [2024.11.0]({{< ref "2024.11.0/" >}})
- [2024.10.0]({{< ref "2024.10.0/" >}})
- [2024.9.0]({{< ref "2024.9.0/" >}})
- [2024.8.0]({{< ref "2024.8.0/" >}})
- [2024.7.0]({{< ref "2024.7.0/" >}})
- [2024.6.0]({{< ref "2024.6.0/" >}})
- [2024.5.0]({{< ref "2024.5.0/" >}})
- [2024.4.0]({{< ref "2024.4.0/" >}})
- [2024.3.0]({{< ref "2024.3.0/" >}})
- [2024.2.0]({{< ref "2024.2.0/" >}})
- [2023.12.0]({{< ref "2023.12.0/" >}})
- [2023.11.0]({{< ref "2023.11.0/" >}})
- [2023.10.0]({{< ref "2023.10.0/" >}})
- [2023.9.0]({{< ref "2023.9.0/" >}})
- [2023.8.0]({{< ref "2023.8.0/" >}})
- [2023.7.0]({{< ref "2023.7.0/" >}})
- [2023.6.0]({{< ref "2023.6.0/" >}})
- [2023.5.0]({{< ref "2023.5.0/" >}})
- [2023.4.0]({{< ref "2023.4.0/" >}})
- [2023.3.0]({{< ref "2023.3.0/" >}})
- [2023.2.0]({{< ref "2023.2.0/" >}})
- [2022.12.0]({{< ref "2022.12.0/" >}})
- [2022.11.0]({{< ref "2022.11.0/" >}})
- [2022.10.0]({{< ref "2022.10.0/" >}})
- [2022.9.0]({{< ref "2022.9.0/" >}})
- [2022.8.0]({{< ref "2022.8.0/" >}})
- [2022.6.0]({{< ref "2022.6.0/" >}})
- [2022.5.0]({{< ref "2022.5.0/" >}})
- [2022.4.0]({{< ref "2022.4.0/" >}})
- [2022.3.0]({{< ref "2022.3.0/" >}})
- [2022.2.0]({{< ref "2022.2.0/" >}})
- [2022.1.0]({{< ref "2022.1.0/" >}})
- [2021.12.0]({{< ref "2021.12.0/" >}})
- [2021.11.0]({{< ref "2021.11.0/" >}})
- [2021.10.0]({{< ref "2021.10.0/" >}})
- [2021.9.0]({{< ref "2021.9.0/" >}})
- [2021.8.0]({{< ref "2021.8.0/" >}})
- [v1.20.0]({{< ref "v1.20.0/" >}})
- [v1.19.0]({{< ref "v1.19.0/" >}})
- [v1.18.0]({{< ref "v1.18.0/" >}})
- [v1.17.0]({{< ref "v1.17.0/" >}})
