---
description: "Changelog - Version 1.10.0"
...
- You can now configured multiple WiFi networks to connect to. The best one will be chosen automatically.
  ...
  ([Connecting to Multiple Networks]({{< ref "components/wifi#wifi-networks" >}}))
...
- docs: Fix substitutions example & api intro text :docspr:`117` by {{< ghuser name="thubot" >}}
...
- docs: Fixed missing link to BME cookbook :docspr:`120` by {{< ghuser name="Mynasru" >}}
- lib: Fix addressable flicker effect :libpr:`383`
- lib: NeoPixelBus: fix handling of white color component :libpr:`384` by {{< ghuser name="badbadc0ffee" >}}
...
- docs: add baud_rate; typo on sensor type :docspr:`90` by {{< ghuser name="drewp" >}}
...
- docs: Fix copy paste error :docspr:`100` by {{< ghuser name="oscar-b" >}}
- lib: Fix large JSON payloads being cut off :libpr:`323` by {{< ghuser name="quazzie" >}}
- docs: Add Wikipedia link to tz database zones list :docspr:`105` by {{< ghuser name="apeeters" >}}
- docs: Add pins for Shelly 2 :docspr:`103` by {{< ghuser name="oscar-b" >}}
- lib: Native Esphomelib API :libpr:`322`
- yaml: Add native ESPHome API :yamlpr:`265`
- lib: Add support for MAX31855 sensor :libpr:`310` by {{< ghuser name="sherbang" >}}
- docs: Documentation for MAX31855 sensor :docspr:`97` by {{< ghuser name="sherbang" >}}
- lib: Fix typo in Output Switch :libpr:`307`
- lib: Fix PCA9685 with many channels :libpr:`304`
- docs: Fixed typo in Sonoff R2 Cover example :docspr:`112` by {{< ghuser name="voicevon" >}}
- lib: Dump native API Server config on boot :libpr:`338` by {{< ghuser name="voicevon" >}}
...
- docs: Fix copy/paste error in turn_off_action :docspr:`113` by {{< ghuser name="wutr" >}}
- yaml: GPIO Switch Fix restore_mode validator :yamlpr:`296` by {{< ghuser name="yottatsa" >}}
...
- yaml: Add support for MAX31855 sensor :yamlpr:`258` by {{< ghuser name="sherbang" >}}
- yaml: ULN2003 Support :yamlpr:`304`
- yaml: Add ESP32 Ethernet Support :yamlpr:`301`
- docs: total_daily_energy doesn't have pin option :docspr:`114` by {{< ghuser name="oscar-b" >}}
- docs: Getting started HassIO - USD device discovery :docspr:`110` by {{< ghuser name="DavidDeSloovere" >}}
- docs: Mismatch in example and text :docspr:`109` by {{< ghuser name="wellsi" >}}
- docs: BME280 environment cookbook entry :docspr:`107` by {{< ghuser name="Mynasru" >}}
- docs: Update getting_started_command_line.rst :docspr:`102` by {{< ghuser name="doskoi" >}}
- docs: Updated the multi click example code block :docspr:`92` by {{< ghuser name="cooljimy84" >}}
- docs: Add step to setting up devices :docspr:`101` by {{< ghuser name="magnusoverli" >}}
...
- yaml: use full space on small devices :yamlpr:`310` by {{< ghuser name="escoand" >}}
