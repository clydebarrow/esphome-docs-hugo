---
description: "Changelog - Version 1.11.0"
...
- docs: Fix units on the valid frequency values :docspr:`170` by {{< ghuser name="kwdavidson" >}}
...
- docs: Merge dallas component :docspr:`179` by {{< ghuser name="FrengerH" >}}
- docs: Correct ultrasonic filter_nan example :docspr:`159` by {{< ghuser name="apeeters" >}}
- docs: Cookbook entry for Display component :docspr:`173` by {{< ghuser name="ahd71" >}}
...
- docs: Add Ethernet pin config for olimex esp32-poe board :docspr:`166` by {{< ghuser name="setola" >}}
- docs: FAQ: Add description for mDNS support on different subnets :docspr:`169` by {{< ghuser name="Taigar2015" >}}
...
- esphome: Remove duplicate scrollbar & move scrollbar :esphomepr:`443` by {{< ghuser name="TheZoker" >}}
- esphome: Remove unnecessary wrapper :esphomepr:`444` by {{< ghuser name="TheZoker" >}}
...
- esphome: typing is only required for python < 3.5 :esphomepr:`341` by {{< ghuser name="dotlambda" >}}
- esphome: Fix install pillow in docker image :esphomepr:`338`
- esphome: Allow IPv4 addresses for SNTP servers :esphomepr:`340`
- docs: Fix esp8266_pwm example, IDs cannot have hyphens :docspr:`123` by {{< ghuser name="rabbadab" >}}
- esphome: Add pyserial to install_requires :esphomepr:`348` by {{< ghuser name="dotlambda" >}}
- docs: Added explanation how to change the password :docspr:`124` by {{< ghuser name="WoLpH" >}}
- docs: Update light lambda effect example :docspr:`125` by {{< ghuser name="jdads1" >}}
...
- docs: Cookbook Entry for Sonoff Basic Fish Pond Pump :docspr:`122` by {{< ghuser name="meijerwynand" >}}
- docs: Add Arilux LC02 pinout :docspr:`130` by {{< ghuser name="pixiandreas" >}}
- docs: Dallas: Update for default update_interval :docspr:`131` by {{< ghuser name="balk77" >}}
...
- esphome: Add ability to run commands using subprocess, instead of in-process :esphomepr:`359` by {{< ghuser name="dotlambda" >}}
...
- esphome: Adding SI7021 sensor to config validation :esphomepr:`375` by {{< ghuser name="grea09" >}}
- core: Add logging to NeoPixelBus :corepr:`438` by {{< ghuser name="badbadc0ffee" >}}
- esphome: Includes should be relative to the src directory, not main.cpp file :esphomepr:`390` by {{< ghuser name="yawor" >}}
- esphome: Generate variable for each custom component id :esphomepr:`382` by {{< ghuser name="yawor" >}}
...
- docs: Fix Typo in BME280 Environment Cookbook :docspr:`145` by {{< ghuser name="hajdbo" >}}
- docs: Updating Repo URLs in Contribution Guide :docspr:`143` by {{< ghuser name="badbadc0ffee" >}}
- core: Update sony.cpp to fix incorrectly formed Sony IR code (extra bit) :corepr:`458` by {{< ghuser name="chris-jennings" >}}
- docs: Extra example in cookbook / flashing DOIT ESP32 :docspr:`138` by {{< ghuser name="DavidDeSloovere" >}}
- docs: Adding the SI7021 to docs :docspr:`147` by {{< ghuser name="grea09" >}}
...
- docs: Remove duplicate "includes" line :docspr:`154` by {{< ghuser name="notgwj" >}}
- core: Remove 'flash' property from MQTT Light discovery JSON. :corepr:`478` by {{< ghuser name="brandond" >}}
- docs: Improve docker build instructions :docspr:`155` by {{< ghuser name="DavidDeSloovere" >}}
...
- docs: Link Home Assistant's include system in FAQ :docspr:`157` by {{< ghuser name="TheHackmeister" >}}
...
- esphome: Add support for JVC remote transmitting and receiving :esphomepr:`423` by {{< ghuser name="jesserockz" >}}
- docs: Add docs for JVC remote transmitting and receiving :docspr:`160` by {{< ghuser name="jesserockz" >}}
- docs: H801 LED controller (remade) :docspr:`158` by {{< ghuser name="erazor666" >}}
- core: Enable use of alternate hardware UARTs for logging :corepr:`483` by {{< ghuser name="brandond" >}}
- esphome: Enable use of alternate hardware UARTs for logging :esphomepr:`427` by {{< ghuser name="brandond" >}}
- docs: Enable use of alternate hardware UARTs for logging  :docspr:`161` by {{< ghuser name="brandond" >}}
...
- esphome: Fix dashboard style issues :esphomepr:`437` by {{< ghuser name="TheZoker" >}}
- esphome: Include tapTarget html element only when needed :esphomepr:`439` by {{< ghuser name="TheZoker" >}}
...
- docs: Custom Binary Sensor: Add missing ";" and fix indentation in YAML :docspr:`164` by {{< ghuser name="mjoshd" >}}
...
- docs: Add Sonoff T1 LED pin :docspr:`165` by {{< ghuser name="lwis" >}}
- esphome: Remove duplicate scrollbar & move scrollbar :esphomepr:`443` by {{< ghuser name="TheZoker" >}} (cherry-picked)
- esphome: Remove unnecessary wrapper :esphomepr:`444` by {{< ghuser name="TheZoker" >}} (cherry-picked)
