---
description: "Changelog - Version 1.12.0"
...
`homeassistant.service` call). With 1.12 you get [User-defined services]({{< ref "components/api#api-device-actions" >}}),
...
- Added `calibrate_linear` sensor filter for easier calibration of sensors
  ([sensor-filter-calibrate_linear]({{< ref "#sensor-filter-calibrate_linear" >}}))
- Added `for` parameter to [binary_sensor.is_on]({{< ref "components/binary_sensor/_index#binary_sensor-is_on_condition" >}}) condition.
...
- docs: Sonoff S20 yaml fix :docspr:`200` by {{< ghuser name="BananaPukeh" >}}
...
- esphome: Better symlink support under Windows :esphomepr:`487` by {{< ghuser name="glmnet" >}}
...
- docs: Expand USB flashing, clarify how to report a bug. :docspr:`204` by {{< ghuser name="balloob" >}}
- core: Fix dallas on GPIO0 :corepr:`568`
- docs: Fix api homeassistant.service docs :docspr:`209` by {{< ghuser name="davericher" >}}
...
- esphome: Add MPR121 Capacitive Touch Sensor :esphomepr:`449` by {{< ghuser name="mvturnho" >}}
...
- esphome: Add handling for min power output setting :esphomepr:`448` by {{< ghuser name="mtl010957" >}}
- docs: Update output documentation for min_power configuration :docspr:`167` by {{< ghuser name="mtl010957" >}}
...
- docs: Component reshuffle :docspr:`183` by {{< ghuser name="FrengerH" >}}
- docs: Add MPR121 support :docspr:`176` by {{< ghuser name="mvturnho" >}}
...
- esphome: Fix gain setting for ADS1115 :esphomepr:`468` by {{< ghuser name="Melkor82" >}}
...
- docs: Add text-based sensor example to OLED cookbook entry :docspr:`190` by {{< ghuser name="tubalainen" >}}
- docs: H801 Cookbook Edit Language about holding GPIOs during flashing :docspr:`189` by {{< ghuser name="2016for" >}}
- docs: Adding manual for Sonoff T1 UK 3 Gang V1.1 :docspr:`182` by {{< ghuser name="nnmalex" >}}
- core: Add SDS011 :corepr:`538` by {{< ghuser name="puuu" >}}
- esphome: Support SDS011 component. :esphomepr:`467` by {{< ghuser name="puuu" >}}
- docs: Document SDS011 component :docspr:`185` by {{< ghuser name="puuu" >}}
- docs: Add Teckin SP20 (US) example to 'Generic Sonoff' page :docspr:`191` by {{< ghuser name="mjoshd" >}}
- esphome: Add color to login error for better visibility :esphomepr:`478` by {{< ghuser name="TheZoker" >}}
- core: Fixed: Waveshare 4.2in display timing problem due to high speed SPI u… :corepr:`546` by {{< ghuser name="dirkj" >}}
- docs: Update information on flashing OTA to old ip :docspr:`193` by {{< ghuser name="tubalainen" >}}
- docs: NeopixelBus Light: Fix GPIO2 not GPIO3 for uart1 method :docspr:`194` by {{< ghuser name="Bierchermuesli" >}}
- docs: Cookbook Guide for Mirabella Genio Smart Bulbs :docspr:`184` by {{< ghuser name="cryptelli" >}}
- docs: Improve bme280_environment cookbook for stable climates :docspr:`149` by {{< ghuser name="hajdbo" >}}
...
- docs: Cookbook Guide for Brilliant / Mirabella Genio Smart Plugs :docspr:`195` by {{< ghuser name="cryptelli" >}}
- esphome: Add ESP32 Camera :esphomepr:`475`
- docs: Add native API User-Defined services :docspr:`171` (cherry-picked)
- docs: BME280 environment micrograms -> grams :docspr:`198` by {{< ghuser name="hajdbo" >}}
