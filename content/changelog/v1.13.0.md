---
description: "Changelog - Version 1.13.0 - May 30th 2019"
...
- {{< docref "/components/light" "Lights" >}} now have some new actions: `light.dim_relative` and
...
- {{< docref "/components/remote_receiver" "Remote Receiver" >}} and {{< docref "/components/remote_transmitter" "Remote Transmitter" >}}
...
- Added [globals.set]({{< ref "components/globals#globals-set_action" >}}) action,
  [script.is_running]({{< ref "components/script#script-is_running_condition" >}}) condition,
  [for]({{< ref "automations/actions#for_condition" >}}) condition.
- Custom components can now access ESPHome's global variables.
- Added `restore_mode` for lights and [light.is_on/off]({{< ref "components/light/_index#light-is_on_condition" >}}).
...
- docs: add note for asynchronously update of adc :docspr:`259` by {{< ghuser name="escoand" >}}

## Release 1.13.3 - June 1

- esphome: List the correct boards when building for ESP32 :esphomepr:`589` by {{< ghuser name="macourteau" >}}
...
- docs: Add missing filter name for ct_clamp :docspr:`258` by {{< ghuser name="jesserockz" >}}
...
- docs: Update integration.rst :docspr:`263` by {{< ghuser name="balk77" >}}
...
- esphome: Fix ForCondition time duration check :esphomepr:`610` by {{< ghuser name="ptatrai" >}}
- docs: Add timezone mapping to Docker compose. :docspr:`266` by {{< ghuser name="jeff-h" >}}
...
- docs: Lambas won't just work with the short name :docspr:`269` by {{< ghuser name="ryannazaretian" >}}
...
- docs: Extend the documentation of esp8266_restore_from_flash to include pla… :docspr:`203` by {{< ghuser name="placidorevilla" >}}
- esphome: TTP229-LSF i2c device support :esphomepr:`489` by {{< ghuser name="mvturnho" >}}
- docs: TTP229-LSF i2c device support :docspr:`205` by {{< ghuser name="mvturnho" >}}
- docs: Remove deprecated filter_nan: option :docspr:`214` by {{< ghuser name="davericher" >}}
- docs: Minor Gramatical fix :docspr:`220` by {{< ghuser name="meichthys" >}}
...
- docs: Stepper combine lambda docs :docspr:`223` by {{< ghuser name="AalianKhan" >}}
- esphome: Simplify coroutine syntax :esphomepr:`503`
- docs: Added a section for all lambda calls :docspr:`222` by {{< ghuser name="AalianKhan" >}}
- docs: Typo in ESP32 Touch Component :docspr:`216` by {{< ghuser name="jcullen86" >}}
- docs: MQTT clean-mqtt: Document for docker :docspr:`210` by {{< ghuser name="bphermansson" >}}
- esphome: Wio_link and wio_node pinout improvements :esphomepr:`505` by {{< ghuser name="sethcohn" >}}
- docs: Voltage range of ADC is at the chip pin :docspr:`224` by {{< ghuser name="kimonm" >}}
- esphome: Escape double quotes and backslashes in ssid and psk :esphomepr:`507` by {{< ghuser name="gitolicious" >}}
- docs: Added Gitpod documentation :docspr:`225` by {{< ghuser name="gitolicious" >}}
- docs: Fixed lint and ref errors :docspr:`228` by {{< ghuser name="gitolicious" >}}
- esphome: 🏗 Merge C++ into python codebase :esphomepr:`504`
- docs: Create .gitpod.yml :docspr:`226` by {{< ghuser name="gitolicious" >}}
- esphome: Cleanup dashboard JS :esphomepr:`491`
- docs: Add esp32_camera ttgo-camera example :docspr:`231` by {{< ghuser name="Naesstrom" >}}
- esphome: Hass.io Ingress :esphomepr:`519`
- docs: Fix config name for showing previous page :docspr:`238` by {{< ghuser name="kevinior" >}}
- docs: fixed copy paste error :docspr:`237` by {{< ghuser name="norges" >}}
- docs: Update switch/index.rst lambda section :docspr:`236` by {{< ghuser name="EmmanuelLM" >}}
- docs: Update h801 cookbook :docspr:`235` by {{< ghuser name="Eenoo" >}}
- esphome: Create .gitpod.yml :esphomepr:`508` by {{< ghuser name="gitolicious" >}}
- esphome: Fix MQTT Not Working in dev branch :esphomepr:`527` by {{< ghuser name="mtl010957" >}}
- esphome: Fix custom_sensor codegen :esphomepr:`526` by {{< ghuser name="emwap" >}}
- esphome: Fix compilation of automations :esphomepr:`525` by {{< ghuser name="envy" >}}
- esphome: Add Custom Component tests :esphomepr:`529` by {{< ghuser name="emwap" >}}
- esphome: Create .editorconfig :esphomepr:`524` by {{< ghuser name="gitolicious" >}}
- docs: Fix minor typo in ESP32 camera docs :docspr:`241` by {{< ghuser name="richrd" >}}
- esphome: Added save & validate button in editor window :esphomepr:`511` by {{< ghuser name="gitolicious" >}}
- esphome: Fix compilation of my9231 component :esphomepr:`533` by {{< ghuser name="puuu" >}}
- esphome: Allow rx_only mode of sds011 component :esphomepr:`534` by {{< ghuser name="puuu" >}}
- esphome: MPU6050 fix temperature reading (wrong datatype) :esphomepr:`532` by {{< ghuser name="norges" >}}
...
- esphome: Make Climate component work over mqtt :esphomepr:`535` by {{< ghuser name="puuu" >}}
- esphome: CCS811 support :esphomepr:`536`
- esphome: GPS time source :esphomepr:`543`
- esphome: TTP229 BSF support :esphomepr:`547`
- docs: Update links :docspr:`243` by {{< ghuser name="oscar-b" >}}
- esphome: Bme680 pressure value fix :esphomepr:`550` by {{< ghuser name="plopp" >}}
- docs: Fix typo in docs mi flora :docspr:`250` by {{< ghuser name="seuros" >}}
- docs: Stepper component: fix typo in doc :docspr:`254` by {{< ghuser name="Johboh" >}}
- esphome: Suggested fix for empty domain :esphomepr:`555` by {{< ghuser name="ASMfreaK" >}}
- docs: Sensor: correct example for on_raw_value :docspr:`255` by {{< ghuser name="Johboh" >}}
- docs: Update bh1750.rst (fix incorrect link text) :docspr:`246` by {{< ghuser name="richrd" >}}
- esphome: Don't fall back to the global availability topic if it is empty :esphomepr:`553` by {{< ghuser name="brandond" >}}
- esphome: Add examples to Nextion page :esphomepr:`548` by {{< ghuser name="AalianKhan" >}}
- esphome: Support for AM2320 temperature and humidity sensor :esphomepr:`554` by {{< ghuser name="T3m3z" >}}
- docs: Documentation for AM2320 component :docspr:`249` by {{< ghuser name="T3m3z" >}}
- esphome: Add TCL112 climate :esphomepr:`523` by {{< ghuser name="glmnet" >}}
- docs: Add Coolix Tcl112 Climate :docspr:`247` by {{< ghuser name="glmnet" >}}
- esphome: Add coolix climate ❄ 🔥 :esphomepr:`521` by {{< ghuser name="glmnet" >}}
- esphome: added link from dashboard to web server, if configured :esphomepr:`556` by {{< ghuser name="gitolicious" >}} (cherry-picked)
...
- docs: extended mpr121 docs with debounce and thresholds config :docspr:`245` by {{< ghuser name="mvturnho" >}} (cherry-picked)
- esphome: Mpr121 added debounce and thresholds config :esphomepr:`558` by {{< ghuser name="mvturnho" >}} (cherry-picked)
- docs: Documentation for binary_sensor_map :docspr:`199` by {{< ghuser name="mvturnho" >}} (cherry-picked)
- esphome: Binary sensor map implementation :esphomepr:`551` by {{< ghuser name="mvturnho" >}} (cherry-picked)
- esphome: Fix CWWW/RGBWW lights :esphomepr:`562` (cherry-picked)
- esphome: added download, edit and retry buttons to upload modal :esphomepr:`557` by {{< ghuser name="gitolicious" >}} (cherry-picked)
- esphome: Renamed upload button :esphomepr:`563` by {{< ghuser name="gitolicious" >}}
- esphome: Warn if a component does long-running work in loop thread :esphomepr:`565`
- esphome: Add CT Clamp component :esphomepr:`559` by {{< ghuser name="jesserockz" >}}
- docs: Add docs for CT Clamp :docspr:`256` by {{< ghuser name="jesserockz" >}}
- docs: Put 'MAC_ADDRESS' instead of MAC_ADDRESS :docspr:`239` by {{< ghuser name="tiagofreire-pt" >}}
...
- esphome: Correctly set warm white variables :esphomepr:`569` by {{< ghuser name="jesserockz" >}}
