...
![With the new :doc:`captive portal </components/captive_portal>` component you can set up a fallback](/components/images/captive_portal-ui.png)
...
![Thank you :ghuser:`glmnet` for your work!](../images/vscode-validation.png)
...
![As always, thanks to all contributors, bug reporters and patrons! Without you this would not](../images/github-1000-stars.png)
