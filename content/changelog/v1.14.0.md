...
{{< docref "/components/light/tuya" "Tuya MCU protocol" >}} (thanks :ghuser:`ssieb` and :ghuser:`brandond`!) has been added and major
...
- You can now specify per-device descriptions in the dashboard interface
  (:esphomepr:`707` by :ghuser:`Anonym-tsk`, {{< docref "/components/esphome" "docs" >}}).
...
- Add support for calibrating MH-Z19 sensors (:esphomepr:`683` by :ghuser:`Anonym-tsk`, {{< docref "/components/sensor/mhz19" "docs" >}}).
...
- Add IR receiver support for coolix climate devices (:esphomepr:`645` by :ghuser:`glmnet`, {{< docref "/components/climate/climate_ir" "docs" >}}).
...
- Allow setting the initial mode of HLW8012 sensors (:esphomepr:`611` by :ghuser:`brandond`, {{< docref "/components/sensor/hlw8012" "docs" >}}).
- Add tilt actions to {{< docref "/components/cover/template" "template cover" >}} (:esphomepr:`577` by :ghuser:`mtl010957`).
- Add backlight handling for lcd_pcf8574 (:esphomepr:`573` by :ghuser:`adarazs`, {{< docref "/components/display/lcd_display" "docs" >}}).
