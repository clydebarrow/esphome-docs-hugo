...
Apart from a few new sensors, we now have built in support for {{< docref "/components/external_components" >}}, check it out. Thanks :ghuser:`OttoWinter` and :ghuser:`glmnet`
