...
* `esphomeflasher` - Experiencing problems flashing esphomelib firmwares using esphomeyaml?
  ...
  from your PC.
* [Over-the-Air Updates ]({{< relref "/components/ota/index" >}}) have been completely re-written to make them a lot more stable.
...
* A new release cycle: esphomeyaml now also has a [How do I update to the latest beta release?]({{< ref "guides/faq#faq-beta" >}}) kind of like Home Assistant. This helps to
...
[How do I report an issue?]({{< ref "guides/faq#faq-bug_report" >}})!

## New Components

- There's a new base component called [text sensors ]({{< relref "/components/text_sensor/index" >}}) for using
  text-based inputs, not just numbers like the generic [sensors ]({{< relref "/components/sensor/index" >}}) did
...
- Added [CSE7766 Power Sensor ]({{< relref "/components/sensor/cse7766" >}}) to support power measurements
...
- Added the [PMSX003 Particulate Matter Sensor ]({{< relref "/components/sensor/pmsx003" >}})
  (:libpr:`229`, :yamlpr:`192`, :docspr:`58`)

- Added support for [A4988 Stepper Motors ]({{< relref "/components/stepper/index" >}}) (:libpr:`239`,
  :yamlpr:`206`, :docspr:`68`)

- Added [total daily energy sensor ]({{< relref "/components/sensor/total_daily_energy" >}}) to accumulate the total
...
- The [Over-the-Air Update ]({{< relref "/components/ota/index" >}}) process was quite buggy sometimes and the Arduino-library
...
- Added an [pn532-on_tag]({{< ref "components/binary_sensor/pn532#pn532-on_tag" >}}) t[PN532 NFC Readers ]({{< relref "/components/binary_sensor/pn532" >}})>` so that automations
...
- You now have to option to have a different log level for log messages sent over MQTT ([MQTTMessage]({{< ref "components/mqtt#mqtt-message" >}}),
  :yamlpr:`167`, :docspr:`51`)

- Added a color correction option to [FastLED addressable lights ]({{< relref "/components/light/fastled" >}})
...
- You can now upload OTA firmware files with the [web server component ]({{< relref "/components/web_server" >}})

- Added the ability to define global variables in esphomeyaml: [/components/globals]({{< ref "/components/globals" >}}).

- Added a `frequency` option to the [/components/output/esp8266_pwm]({{< ref "/components/output/esp8266_pwm" >}}).
...
- esphomelib's naming convention has been made more consistent. If you're not using any [Templates]({{< ref "automations/templates#config-lambda" >}}),
