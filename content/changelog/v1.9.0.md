---
description: "Changelog - Version 1.9.0"
...
* `esphomeflasher` - Experiencing problems flashing esphomelib firmwares using esphomeyaml?
  ...
  from your PC.
* {{< docref "/components/ota" "Over-the-Air Updates" >}} have been completely re-written to make them a lot more stable.
...
* A new release cycle: esphomeyaml now also has a [beta release channel]({{< ref "guides/faq#faq-beta" >}}) kind of like Home Assistant. This helps to
...
[reporting bugs]({{< ref "guides/faq#faq-bug_report" >}})!

## New Components

- There's a new base component called {{< docref "/components/text_sensor" "text sensors" >}} for using
  text-based inputs, not just numbers like the generic {{< docref "/components/sensor" "sensors" >}} did
...
- Added support for {{< docref "/components/stepper" "A4988 Stepper Motors" >}} (:libpr:`239`,
...
- ESP8266s now save the states of lights/switches/... internally and restores them on boot.
  ...
  or the MQTT broker is unreachable, see [Do Automations Work Without a Network Connection]({{< ref "automations/actions#automation-networkless" >}})
  (:libpr:`258`, :libpr:`267`, :yamlpr:`229`)

- The {{< docref "/components/ota" "Over-the-Air Update" >}} process was quite buggy sometimes and the Arduino-library
...
- Added [`mqtt.publish_json` Action]({{< ref "components/mqtt#mqtt-publish_json_action" >}}) and [`on_json_message` Trigger]({{< ref "components/mqtt#mqtt-on_json_message" >}}) to make using JSON for MQTT payloads easier
...
- Added [`script.execute` Action]({{< ref "components/script#script-execute_action" >}}), [`logger.log` Action]({{< ref "components/logger#logger-log_action" >}}) and [`component.update` Action]({{< ref "automations/actions#component-update_action" >}}) for simplifying
  automations
  (:libpr:`232`, :yamlpr:`196`, :yamlpr:`198`, :docspr:`61`, :docspr:`63`)

- Added [`on_multi_click`]({{< ref "components/binary_sensor/_index#binary_sensor-on_multi_click" >}}) trigger to distinguish between double, long, and single clicks.
  (:libpr:`262`, :docspr:`77`,  :yamlpr:`226`)

- Added an [pn532-on_tag]({{< ref "components/binary_sensor/pn532#pn532-on_tag" >}}) t{{< docref "/components/binary_sensor/pn532" "PN532 NFC Readers" >}}>` so that automations
...
- You now have to option to have a different log level for log messages sent over MQTT ([docs]({{< ref "components/mqtt#mqtt-message" >}}),
...
- esphomelib's naming convention has been made more consistent. If you're not using any [lambdas]({{< ref "automations/templates#config-lambda" >}}),
...
- docs: Fix Sonoff Basic pinouts :docspr:`88` by {{< ghuser name="sherbang" >}}
- docs: Update cwww.rst :docspr:`85` by {{< ghuser name="Melkor82" >}}
...
- yaml: Add a link to Home Assistant in README :yamlpr:`152` by {{< ghuser name="jonnyair" >}}
- lib: Add a link to Home Assistant in README.md :libpr:`184` by {{< ghuser name="jonnyair" >}}
...
- yaml: Add Samsung IR protocol :yamlpr:`176` by {{< ghuser name="escoand" >}} (new-feature)
- docs: add samsung ir protocol :docspr:`48` by {{< ghuser name="escoand" >}} (new-feature)
...
- lib: Fix PCF8574 assert. :libpr:`223` by {{< ghuser name="lobradov" >}}
...
- docs: Switch example to Dehumidifier, minor grammar/puncuation :docspr:`67` by {{< ghuser name="rorpage" >}}
- docs: Tiny typo fix. :docspr:`73` by {{< ghuser name="corbanmailloux" >}}
- yaml: Auto-Decode stacktraces :yamlpr:`214` (new-feature)
- docs: Fix a broken link to setting up a BLE tracker. :docspr:`72` by {{< ghuser name="corbanmailloux" >}}
...
- lib: MY9231/MY9291 LED driver support :libpr:`266` by {{< ghuser name="puuu" >}} (new-feature)
- yaml: Add MY9231 support :yamlpr:`227` by {{< ghuser name="puuu" >}} (new-feature)
- docs: MY9231/MY9291 LED driver documentation :docspr:`80` by {{< ghuser name="puuu" >}} (new-feature)
