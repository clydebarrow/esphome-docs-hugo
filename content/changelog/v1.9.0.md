...
- ESP8266s now save the states of lights/switches/... internally and restores them on boot.
  ...
  or the MQTT broker is unreachable, see [automation-networkless]({{< ref "automations/actions#automation-networkless" >}})
...
- Added [mqtt-publish_json_action]({{< ref "components/mqtt#mqtt-publish_json_action" >}}) and [mqtt-on_json_message]({{< ref "components/mqtt#mqtt-on_json_message" >}}) to make using JSON for MQTT payloads easier
...
- Added [script-execute_action]({{< ref "components/script#script-execute_action" >}}), [logger-log_action]({{< ref "components/logger#logger-log_action" >}}) and [component-update_action]({{< ref "automations/actions#component-update_action" >}}) for simplifying
  automations
  (:libpr:`232`, :yamlpr:`196`, :yamlpr:`198`, :docspr:`61`, :docspr:`63`)

- Added [binary_sensor-on_multi_click]({{< ref "components/binary_sensor/_index#binary_sensor-on_multi_click" >}}) trigger to distinguish between double, long, and single clicks.
