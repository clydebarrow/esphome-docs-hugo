---
description: "AirTouch AT581x Radar"
...
a [/components/i2c]({{< ref "/components/i2c" >}}) component (and its requisite GPIO pins) is required in your device's configuration.

![AirTouch AT581x Radar / presence detection sensor](../images/at581x.png)
...
A [/components/binary_sensor/gpio]({{< ref "/components/binary_sensor/gpio" >}}) alone could be sufficient if you only want
...
Multiple instances of this component may be defined if multiple [/components/i2c]({{< ref "/components/i2c" >}}) components are available:
...
- **i2c_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of[/components/i2c]({{< ref "/components/i2c" >}})/i2c` if you want
...
```
- Refer to other options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) and :doc:`GPIO Binary Sens[GPIO Binary Sensor ]({{< relref "/components/binary_sensor/gpio" >}})


## Switch

[Switch components]({{< ref "components/switch/_index#config-switch" >}}) are used to enable/disable radio frequency hardware.
...
- **at581x_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the AT581x component defined above.
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the sensor on which settings should be
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the AT581x component. Useful when multiple instances of this component are defined.

## See Also
- [I2C bus]({{< ref "components/i2c#i2c" >}})
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/at581x.md)
