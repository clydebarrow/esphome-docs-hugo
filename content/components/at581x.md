...
- **i2c_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the {{< docref "/components/i2c" >}} if you want
...
- **at581x_id** (*Optional*, [config-id](#config-id)): The ID of the AT581x component defined above.
...
- **id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the sensor on which settings should be
...
- **id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the AT581x component. Useful when multiple instances of this component are defined.
