...
```
- Refer to other options from [Binary Sensor](components/binary_sensor/_index#config-binary_sensor) and {{< docref "/components/binary_sensor/gpio" "GPIO Binary Sensor" >}}.

{{< anchor "at581x-switch" >}}

## Switch

[Switch components](components/switch/_index#config-switch) are used to enable/disable radio frequency hardware.
