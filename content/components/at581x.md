...
```
- Refer to other options from [Base Binary Sensor Configuration]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) and :doc:`GPIO Binary Sens{{< docref "/components/binary_sensor/gpio" "GPIO Binary Sensor" >}}
