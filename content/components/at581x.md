...
- **i2c_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of{{< docref "/components/i2c" >}}/i2c` if you want
...
```
- Refer to other options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) and :doc:`GPIO Binary Sens{{< docref "/components/binary_sensor/gpio" "GPIO Binary Sensor" >}}
