...
- **i2c_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of[/components/i2c]({{< ref "/components/i2c" >}})/i2c` if you want
...
```
- Refer to other options from [Base Binary Sensor Configuration]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) and :doc:`GPIO Binary Sens[GPIO Binary Sensor ]({{< relref "/components/binary_sensor/gpio" >}})

{{< anchor "at581x-switch" >}}

## Switch

[Base Switch Configuration]({{< ref "components/switch/_index#config-switch" >}}) are used to enable/disable radio frequency hardware.
...
- **at581x_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of the AT581x component defined above.
...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the sensor on which settings should be
...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the AT581x component. Useful when multiple instances of this component are defined.
