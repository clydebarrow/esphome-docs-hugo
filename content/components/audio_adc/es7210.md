...
The [I²C bus](components/i2c#i2c) is required in your configuration as this is used to communicate with the ES7210.
...
- **i2c_id** (*Optional*): The ID of the [I²C bus](components/i2c#i2c) the ES7210 is connected to.
