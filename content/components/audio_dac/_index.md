...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The ID of the `audio_dac` platform.
...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The ID of the `audio_dac` platform.
- **volume** (**Required**, percentage, [templatable](automations/templates#config-templatable)): The desired volume level for the
