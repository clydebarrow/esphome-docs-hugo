...
The [I²C bus](components/i2c#i2c) is required in your configuration as this is used to communicate with the ES8311.
...
- **i2c_id** (*Optional*): The ID of the [I²C bus](components/i2c#i2c) the ES8311 is connected to.
- All other options from [Audio DAC](components/audio_dac/_index#config-audio_dac).

## Automations

All [Audio DAC Automations](components/audio_dac/_index#automations-audio_dac) are supported by this platform.
