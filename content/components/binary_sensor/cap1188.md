---
description: "CAP1188 Capacitive Touch Sensor"
...
`Adafruit`_) Capacitive Touch Sensor with ESPHome. The [I²C]({{< ref "components/i2c#i2c" >}}) bus is
required to be set up in your configuration for this sensor to work.

![CAP1188 Capacitive Touch Sensor. Image by `Adafruit`_.](../images/cap1188-full.jpg)
...
- **reset_pin** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): Set the pin that is used to reset the CAP1188 board on boot.
...
First, setup a [cap1188-component]({{< ref "components/binary_sensor/cap1188#cap1188-component" >}}) and then use this binary sensor platform to create individual
...
- **cap1188_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the CAP1188 defined above. Useful for multiple CAP1188's on the I²C bus.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/binary_sensor/cap1188.md)
