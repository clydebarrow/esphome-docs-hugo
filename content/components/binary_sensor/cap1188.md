...
- **id** (*Optional*, [config-id](#config-id)): Set the ID of this sensor.
- **reset_pin** (*Optional*, [config-pin](#config-pin)): Set the pin that is used to reset the CAP1188 board on boot.
...
First, setup a [cap1188-component](#cap1188-component) and then use this binary sensor platform to create individual
...
- **cap1188_id** (*Optional*, [config-id](#config-id)): The ID of the CAP1188 defined above. Useful for multiple CAP1188's on the I²C bus.
