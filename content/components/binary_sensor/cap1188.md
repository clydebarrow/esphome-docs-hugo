...
- **reset_pin** (*Optional*, [Pin](guides/configuration-types#config-pin)): Set the pin that is used to reset the CAP1188 board on boot.
...
First, setup a [Component/Hub](components/binary_sensor/cap1188#cap1188-component) and then use this binary sensor platform to create individual
...
- **cap1188_id** (*Optional*, [ID](guides/configuration-types#config-id)): The ID of the CAP1188 defined above. Useful for multiple CAP1188's on the I²C bus.
