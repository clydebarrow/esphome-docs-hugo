...
-  **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for code generation.
...
- **sleep_duration** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Set a time period
...
- **measurement_duration** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Set the conversion
...
- **iir_filter** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Optionally set up an
...
- **waterproof_guard_ring** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): Sets the touch channel to use for the guard pad. The guard
...
-  **threshold** (**Required**, `int`): The threshold to use to detect touch events. See
   [esp32-finding-thresholds]({{< ref "components/binary_sensor/esp32_touch#esp32-finding-thresholds" >}}) below for help determining this value.
-  **wakeup_threshold** (*Optional*, `int`): The threshold to use to detect touch events to wake-up from deep sleep.
   See [esp32-finding-thresholds]({{< ref "components/binary_sensor/esp32_touch#esp32-finding-thresholds" >}}) below for help determining this value. Touch pad sensors that should trigger a
   wake-up from deep sleep must specify this value. The [deep_sleep-component]({{< ref "components/deep_sleep#deep_sleep-component" >}}) must also be configured to enable
