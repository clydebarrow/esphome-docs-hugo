...
`Adafruit`_) Capacitive Touch Sensor with ESPHome. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) is
...
First, setup a [Component/Hub]({{< ref "components/binary_sensor/mpr121#mpr121-component" >}}) and then use this binary sensor platform to create individual
...
- **mpr121_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of the MPR121 defined above. Useful for multiple MPR121's on the I²C bus
