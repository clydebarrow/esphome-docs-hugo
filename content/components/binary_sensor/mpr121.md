---
description: "MPR121 Capacitive Touch Sensor"
...
`Adafruit`_) Capacitive Touch Sensor with ESPHome. The [I²C]({{< ref "components/i2c#i2c" >}}) is
required to be set up in your configuration for this sensor to work.

![MPR121 Capacitive Touch Sensor. Image by `Adafruit`_.](../images/mpr121-full.jpg)
...
First, setup a [mpr121-component]({{< ref "components/binary_sensor/mpr121#mpr121-component" >}}) and then use this binary sensor platform to create individual
...
- **mpr121_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the MPR121 defined above. Useful for multiple MPR121's on the I²C bus
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/binary_sensor/mpr121.md)
