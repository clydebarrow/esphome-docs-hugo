...
with ESPHome. This component is a global hub that establishes the connection to the PN532 via [SPI]({{< ref "components/spi#spi" >}}) or [I²C]({{< ref "components/i2c#i2c" >}}) and
...
You will need to have the [SPI Bus]({{< ref "components/spi#spi" >}}) or the [I²C Bus]({{< ref "components/i2c#i2c" >}}) configured depending on your choice.
...
- **on_tag** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when a tag is read. See [pn532-on_tag]({{< ref "components/binary_sensor/pn532#pn532-on_tag" >}}).
- **i2c_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the [I²C Component]({{< ref "components/i2c#i2c" >}}) if you want
