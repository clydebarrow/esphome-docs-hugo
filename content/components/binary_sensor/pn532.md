...
See [Setting Up Tags]({{< ref "components/binary_sensor/pn532#pn532-setting_up_tags" >}}) for information on how to setup individual binary sensors for this component.
