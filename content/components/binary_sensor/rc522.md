...
that establishes the connection to the RC522 via [SPI]({{< ref "components/spi#spi" >}}). Using [RC522 binary sensors]({{< ref "components/binary_sensor/rc522#rc522-binary_sensor" >}}),
