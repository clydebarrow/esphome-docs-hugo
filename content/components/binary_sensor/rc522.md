...
![The ``rc522`` component allows you to use RC522 NFC/RFID controllers](../images/rc522-full.jpg)
...
You can also use the tag information directly within ESPHome automations/lambdas. See [rc522-setting_up_tags]({{< ref "components/binary_sensor/rc522#rc522-setting_up_tags" >}}) for
...
- If you have a RC522 which communicates via I²C (as on the M5 Stack), you need to have an [I²C]({{< ref "components/i2c#i2c" >}}) bus configured.

## Over SPI

The `rc522_spi` component allows you to use RC522 NFC/RFID controllers with ESPHome. This component is a global hub
that establishes the connection to the RC522 via [RC522 binary sensors]({{< ref "components/binary_sensor/rc522#rc522-binary_sensor" >}}). Using [SPI]({{< ref "components/spi#spi" >}}),
...
- **update_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The duration of each scan on the RC522. This affects the
...
- **on_tag** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when a tag is read. See
  [rc522-on_tag]({{< ref "components/binary_sensor/rc522#rc522-on_tag" >}}).
- **on_tag_removed** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform after a tag is removed. See
  [rc522-on_tag_removed]({{< ref "components/binary_sensor/rc522#rc522-on_tag_removed" >}}).

## Over I²C

The `rc522_i2c` component allows you to use RC522 NFC/RFID controllers with ESPHome. This component is a global hub
that establishes the connection to the RC522 via [I²C]({{< ref "components/i2c#i2c" >}}) (also available over SPI). Using the
[RC522 binary sensors]({{< ref "components/binary_sensor/rc522#rc522-binary_sensor" >}}) you can then create individual binary sensors that track if
