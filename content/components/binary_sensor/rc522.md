...
You can also use the tag information directly within ESPHome automations/lambdas. See [rc522-setting_up_tags](#rc522-setting_up_tags) for
...
- **update_interval** (*Optional*, [config-time](#config-time)): The duration of each scan on the RC522. This affects the
