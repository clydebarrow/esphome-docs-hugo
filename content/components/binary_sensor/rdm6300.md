...
with ESPHome. This component is a global hub that establishes the connection to the RDM6300 via [UART](components/uart#uart) and
translates the received data. Using the [RDM6300 binary sensors](components/binary_sensor/rdm6300#rdm6300-tag) you can then
...
to have an [UART bus](components/uart#uart) in your configuration with the `rx_pin` connected to the data pin of the RDM6300 and
