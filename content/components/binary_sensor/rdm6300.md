...
See [rdm6300-setting_up_tags](#rdm6300-setting_up_tags) for information on how to setup individual binary sensors for this component.
...
- **on_tag** (*Optional*, [Automation](#automation)): An automation to perform
  when a tag is read. See [rdm6300-on_tag](#rdm6300-on_tag).
