...
See [Setting Up Tags](components/binary_sensor/rdm6300#rdm6300-setting_up_tags) for information on how to setup individual binary sensors for this component.
...
- **on_tag** (*Optional*, [Automation](automations/_index#automation)): An automation to perform
  when a tag is read. See [`on_tag`](components/binary_sensor/rdm6300#rdm6300-on_tag).
