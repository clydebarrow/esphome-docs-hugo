...
![A more complex option is to properly convert the 3.3V and 5V logic levels with a level shifter.](../images/canbus_mcp2515_resistor.png)
*A more complex option is to properly convert the 3.3V and 5V logic levels with a level shifter.*


![See Also](../images/canbus_mcp2515_txs0108e.png)
*See Also*
