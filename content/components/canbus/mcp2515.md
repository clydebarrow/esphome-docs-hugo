...
The MCP2515 communicates with ESPHome via the [SPI Bus]({{< ref "components/spi#spi" >}}); to use it, you must have at least one
[SPI Bus]({{< ref "components/spi#spi" >}}) with both the `mosi_pin` and `miso_pin` defined in your ESPHome configuration.

The [Wiring options]({{< ref "components/canbus/mcp2515#mcp2515-wiring" >}}) section below illustrates how to wire up your MCP2515.
...
- **cs_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): Is used to signal to a SPI device when it should
...
{{< img src="canbus_mcp2515_resistor.png" alt="Image" caption="A more complex option is to properly convert the 3.3V and 5V logic levels with a level shifter." class="center" >}}

{{< img src="canbus_mcp2515_txs0108e.png" alt="Image" caption="See Also" class="center" >}}

--------

- [index]({{< ref "index/" >}})
- :apiref:`canbus/canbus.h`
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/canbus/mcp2515.md)
