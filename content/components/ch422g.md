---
description: "CH422G I/O Expander"
...
It uses an [I²C Bus]({{< ref "components/i2c#i2c" >}}) for communication. The I²C address is not configurable as the CH422G has a separate address for each internal register.
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this `ch422g` component.
...
- **ch422g** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the `ch422g` component of the pin.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/ch422g.md)
