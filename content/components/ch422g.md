...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this `ch422g` component.



## Pin configuration variables:

- **ch422g** (**Required**, [ID](guides/configuration-types#config-id)): The id of the `ch422g` component of the pin.
