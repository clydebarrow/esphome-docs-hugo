...
- **mode** (*Optional*, string, [templatable](automations/templates#config-templatable)): Put the climate device
...
- **target_temperature** (*Optional*, float, [templatable](automations/templates#config-templatable)): Set the
  target temperature of a climate device.
- **target_temperature_low** (*Optional*, float, [templatable](automations/templates#config-templatable)): Set the
  lower target temperature of a climate device with a two-point target temperature.
- **target_temperature_high** (*Optional*, float, [templatable](automations/templates#config-templatable)): Set the
  higher target temperature of a climate device with a two-point target temperature.
- **target_humidity** (*Optional*, float, [templatable](automations/templates#config-templatable)): Set the
  target humidity of a climate device.
- **preset** (*Optional*, string, [templatable](automations/templates#config-templatable)): Set the preset
  of the climate device. One of `ECO`, `AWAY`, `BOOST`, `COMFORT`, `HOME`, `SLEEP`,
  `ACTIVITY`.
- **custom_preset** (*Optional*, string, [templatable](automations/templates#config-templatable)): Set one of the
  supported custom_presets of the climate device.
- **fan_mode** (*Optional*, string, [templatable](automations/templates#config-templatable)): Set the fan mode
  of the climate device. One of `ON`, `OFF`, `AUTO`, `LOW`, `MEDIUM`, `HIGH`, `MIDDLE`,
  `FOCUS`, `DIFFUSE`, `QUIET`.
- **custom_fan_mode** (*Optional*, string, [templatable](automations/templates#config-templatable)): Set one of the
  supported custom_fan_modes of the climate device.
- **swing_mode** (*Optional*, string, [templatable](automations/templates#config-templatable)): Set the swing mode
