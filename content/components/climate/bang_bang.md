...
two key differences between the bang-bang component and the [thermostat ]({{< relref "thermostat/" >}}) component:
...
The [thermostat ]({{< relref "thermostat/" >}}) component differs in that there is hysteresis around *each* set point. For example,
...
is associated with heating while the other with cooling, and this is exactly how the [thermostat ]({{< relref "thermostat/" >}})
...
- If you have a dual-function system (both heating and cooling), you'll almost certainly want to use the
  [thermostat ]({{< relref "thermostat/" >}}) component.
...
In all other situations, the [thermostat ]({{< relref "thermostat/" >}}) component is probably best.
