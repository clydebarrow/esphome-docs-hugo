...
- **heating_state_pin** (*Optional*, [Pin](guides/configuration-types#config-pin)): The input pin indicating that the device is heating - [see below](components/climate/tuya#active_state_detection). Only used if **active_state_datapoint** is not configured.
- **cooling_state_pin** (*Optional*, [Pin](guides/configuration-types#config-pin)): The input pin indicating that the device is cooling - [see below](components/climate/tuya#active_state_detection). Only used if **active_state_datapoint** is not configured.
