...
See [Setting Up Devices]({{< ref "components/binary_sensor/ble_presence#esp32_ble_tracker-setting_up_devices" >}}) for
how to discover the MAC address.

To make use of the battery and light level sensors, see the
[/components/sensor/am43]({{< ref "/components/sensor/am43" >}}) component.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/cover/am43.md)
