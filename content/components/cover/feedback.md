...
It can be used to replace a [/components/cover/current_based]({{< ref "/components/cover/current_based" >}}), with some modifications in the yaml. See [migrating_current_based]({{< ref "components/cover/feedback#migrating_current_based" >}})
...
- **open_endstop** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
  [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) that turns on when the open position is reached.
- **open_sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
...
- **open_obstacle_sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
...
- **close_endstop** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
  [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) that turns on when the closed position is reached.
- **close_sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
...
- **close_obstacle_sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the
  [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}) that turns on when an obstacle that blocks the
...
- **max_duration** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The maximum duration the cover should be opening
  or closing. Useful for protecting from dysfunctional endstops.
  Requires internal, builtin or inferred endstops.
- **direction_change_wait_time** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Stops cover and forces a wait time between changes in direction,
...
- **acceleration_wait_time** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Considers a wait time needed by the cover to actually
