...
connection and requires a [UART Bus](components/uart#uart) component to be configured. The uart **must** be set to 1200 baud, EVEN parity. See
...
- **open_duration** (*Optional*, [Time](guides/configuration-types#config-time)): The time required for the door to fully open from the closed position. Default 15s.
- **close_duration** (*Optional*, [Time](guides/configuration-types#config-time)): The time required for the door to fully close from the open position. Default 15s.
