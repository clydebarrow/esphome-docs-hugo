...
- **sleep_duration** (*Optional*, [templatable]({{< ref "automations/templates#config-templatable" >}}), [Time]({{< ref "guides/configuration-types#config-time" >}})): The time duration to stay in deep sleep mode. If a template is used, it should return a value in milliseconds.
