...
![DFRobot mmWave Radar / presence detection sensor](../images/dfrobot_sen0395-full.jpg)
...
First, setup a [/components/uart]({{< ref "/components/uart" >}}) and [dfrobot_sen0395-component]({{< ref "components/dfrobot_sen0395#dfrobot_sen0395-component" >}}) and then use its binary sensor platform
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the mmWave sensor on which settings should be
...
- **output_latency** (*Optional*, dictionary):
  ...
  - **delay_after_detect** (**Required**, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Time to wait before signaling that a person was
  ...
  - **delay_after_disappear** (**Required**, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Time to wait before signaling that a person
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the mmWave component. Useful when multiple instances of this component are defined.
