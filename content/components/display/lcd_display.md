...
- **data_pins** (**Required**, list of [pins](guides/configuration-types#config-pin_schema)): A list of the data pins you
...
- **enable_pin** (**Required**, [pin](guides/configuration-types#config-pin_schema)): The pin you have `E` (`06`) hooked up to.
