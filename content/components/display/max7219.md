...
- **lambda** (*Optional*, [lambda](#config-lambda)): The lambda to use for rendering the content on the MAX7219.
  See [display-max7219_lambda](#display-max7219_lambda) for more information.
...
The MAX7219 has a similar API to the fully fledged [display-engine](#display-engine), but it's only a subset as the MAX7219
