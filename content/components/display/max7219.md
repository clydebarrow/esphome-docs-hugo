---
description: "MAX7219 7-Segment Display"
...
![MAX7219 7-Segment Display.](../images/max7219-full.jpg)
...
- **lambda** (*Optional*, [Templates]({{< ref "automations/templates#config-lambda" >}})): The lambda to use for rendering the content on the MAX7219.
  See [Rendering Lambda]({{< ref "components/display/max7219#display-max7219_lambda" >}}) for more information.
...
The MAX7219 has a similar API to the fully fledged [Display Rendering Engine]({{< ref "components/display/_index#display-engine" >}}), but it's only a subset as the MAX7219
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/max7219.md)
