...
- **scroll_speed** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Set scroll speed. Defaults to `250ms`
- **scroll_delay** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Set delay time before scroll starts. Defaults to `1s`.
- **scroll_dwell** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Sets the wait time at the end of the scroll before starting
...
- **lambda** (*Optional*, [lambda]({{< ref "automations/templates#config-lambda" >}})): The lambda to use for rendering the content on the
  MAX7219. See [display-max7219digit_lambda]({{< ref "components/display/max7219digit#display-max7219digit_lambda" >}}) for more information.
...
The MAX7219 digit is based on the fully fledged [display-engine]({{< ref "components/display/_index#display-engine" >}}), as it has a concept of individual pixels 8 X 8
