---
description: "PCD 8544 Display (Nokia 5110/3310)"
...
displays with ESPHome. Connection to this display is made using the 4-Wire [SPI bus]({{< ref "components/spi#spi" >}}).

It's a monochrome LCD display was used in old Nokia 5110/3310 cell phones.

The resolution of the display is 84x48 pixels.

![PCD8544 Display](../images/pcd8544-full.jpg)
*PCD8544 Display*
...
To use a backlight LIGHT pin needs to be connected to ground. If connected to GPIO pin it can be controlled from ESPHome. See [/components/light/monochromatic]({{< ref "/components/light/monochromatic" >}}).


Configuration variables:
************************

- **reset_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The RESET pin.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/pcd8544.md)
