...
ESP-IDF. PSRAM is a requirement due to the size of the display buffer. A [quad SPI bus](components/spi#spi) interface must be configured.
...
- **enable_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The display enable pin.
