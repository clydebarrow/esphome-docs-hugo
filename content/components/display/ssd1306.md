...
If your SSD1306/SSD1305 or SH1106 is connected via the 4-Wire [Over SPI]({{< ref "components/display/ssd1306#ssd1306-spi" >}}), see [SPI Bus]({{< ref "components/spi#spi" >}}).
...
- **address** (*Optional*, int): Manually specify the [I²C Bus]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3C.
...
If your SSD1306 or SH1106 is connected via the [Over I²C]({{< ref "components/display/ssd1306#ssd1306-i2c" >}}), see [I²C Bus]({{< ref "components/i2c#i2c" >}}).
