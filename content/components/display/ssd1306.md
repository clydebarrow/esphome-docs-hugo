...
displays with ESPHome. Note that this component is for displays that are connected via the [I²C Bus]({{< ref "components/i2c#i2c" >}}).
If your SSD1306/SSD1305 or SH1106 is connected via the 4-Wire [ssd1306-spi]({{< ref "components/display/ssd1306#ssd1306-spi" >}}), see [SPI bus]({{< ref "components/spi#spi" >}}).

![SSD1306 OLED Display](../images/ssd1306-full.jpg)
*SSD1306 OLED Display*


Connect D2 to the SCL pin you chose for the [I²C Bus]({{< ref "components/i2c#i2c" >}}), and connect D1 to the SDA pin. For power, connect
...
- **address** (*Optional*, int): Manually specify the [I²C]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3C.
...
If your SSD1306 or SH1106 is connected via the [ssd1306-i2c]({{< ref "components/display/ssd1306#ssd1306-i2c" >}}), see [I²C Bus]({{< ref "components/i2c#i2c" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/ssd1306.md)
