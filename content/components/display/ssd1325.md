---
description: "SSD1325/7 OLED Display"
...
component is for displays that are connected via the 4-Wire [SPI bus]({{< ref "components/spi#spi" >}}).

![SSD1325 OLED Display](../images/ssd1325-full.jpg)
...
- **cs_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin on the ESP that that the CS line is connected to.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/ssd1325.md)
