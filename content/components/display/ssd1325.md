...
component is for displays that are connected via the 4-Wire [SPI bus](components/spi#spi).
...
- **cs_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin on the ESP that that the CS line is connected to.
