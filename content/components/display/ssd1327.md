...
[SPI bus](components/spi#spi), see [Over SPI](components/display/ssd1327#ssd1327-spi).
...
If your SSD1327 is connected via the [I²C Bus](components/i2c#i2c), see [Over I²C](components/display/ssd1327#ssd1327-i2c).
