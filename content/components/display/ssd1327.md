---
description: "SSD1327 OLED Display"
...
SSD1327 ([datasheet](https://www.generationrobots.com/media/Ecran_OLED_0_96/SSD1327_datasheet.pdf),
[Waveshare](https://www.waveshare.com/1.5inch-oled-module.htm)) displays with ESPHome. Note that this component is for
displays that are connected via the [I²C Bus]({{< ref "components/i2c#i2c" >}}). If your SSD1327 is connected via the 4-Wire
[ssd1327-spi]({{< ref "components/display/ssd1327#ssd1327-spi" >}}), see [SPI bus]({{< ref "components/spi#spi" >}}).

![SSD1327 OLED Display](../images/ssd1327-full.jpg)
*SSD1327 OLED Display*


Connect CLK to the SCL (clock) pin you chose for the [I²C Bus]({{< ref "components/i2c#i2c" >}}) and connect DIN to the SDA (data) pin.
...
- **address** (*Optional*, int): Manually specify the [I²C]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3D.
...
displays with ESPHome. Note that this component is for displays that are connected via the 4-Wire [SPI bus]({{< ref "components/spi#spi" >}}).
If your SSD1327 is connected via the [ssd1327-i2c]({{< ref "components/display/ssd1327#ssd1327-i2c" >}}), see [I²C Bus]({{< ref "components/i2c#i2c" >}}).

![SSD1327 OLED Display](../images/ssd1327-full.jpg)
*SSD1327 OLED Display*


Connect CLK to the SCK (clock) pin you chose for the [SPI bus]({{< ref "components/spi#spi" >}}), connect DIN to the MOSI/SDO pin, and connect `DC`
...
please see [color]({{< ref "components/display/_index#config-color" >}}) for more details. As this is a grayscale display, it only uses the white color
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/ssd1327.md)
