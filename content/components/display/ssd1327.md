...
[SPI bus]({{< ref "components/spi#spi" >}}), see [Over SPI]({{< ref "components/display/ssd1327#ssd1327-spi" >}}).
...
If your SSD1327 is connected via the [I²C Bus]({{< ref "components/i2c#i2c" >}}), see [Over I²C]({{< ref "components/display/ssd1327#ssd1327-i2c" >}}).
