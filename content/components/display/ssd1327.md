...
displays that are connected via the [I²C Bus](components/i2c#i2c). If your SSD1327 is connected via the 4-Wire
[SPI bus](components/spi#spi), see [Over SPI]({{< ref "components/display/ssd1327#ssd1327-spi" >}}).

{{< img src="ssd1327-full.jpg" alt="Image" caption="SSD1327 OLED Display" width="75.0%" class="center" >}}

Connect CLK to the SCL (clock) pin you chose for the [I²C Bus](components/i2c#i2c) and connect DIN to the SDA (data) pin.
...
- **address** (*Optional*, int): Manually specify the [I²C](components/i2c#i2c) address of the display. Defaults to 0x3D.
...
displays with ESPHome. Note that this component is for displays that are connected via the 4-Wire [SPI bus](components/spi#spi).
If your SSD1327 is connected via the [I²C Bus](components/i2c#i2c), see [Over I²C]({{< ref "components/display/ssd1327#ssd1327-i2c" >}}).

{{< img src="ssd1327-full.jpg" alt="Image" caption="SSD1327 OLED Display" width="75.0%" class="center" >}}

Connect CLK to the SCK (clock) pin you chose for the [SPI bus](components/spi#spi), connect DIN to the MOSI/SDO pin, and connect `DC`
...
please see [color](components/display/_index#config-color) for more details. As this is a grayscale display, it only uses the white color
