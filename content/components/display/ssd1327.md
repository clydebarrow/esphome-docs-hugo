...
[Over SPI]({{< ref "components/display/ssd1327#ssd1327-spi" >}}), see [SPI Bus]({{< ref "components/spi#spi" >}}).
...
- **address** (*Optional*, int): Manually specify the [I²C Bus]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3D.
...
If your SSD1327 is connected via the [Over I²C]({{< ref "components/display/ssd1327#ssd1327-i2c" >}}), see [I²C Bus]({{< ref "components/i2c#i2c" >}}).
