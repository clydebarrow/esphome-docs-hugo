...
displays with ESPHome. This component is for displays that are connected via the 4-Wire [SPI bus](components/spi#spi).
...
- **cs_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin on the ESP that that the CS line is connected to.
...
Add a `color:` section to your YAML configuration; please see [color](components/display/_index#config-color) for more detail on this configuration section.
