---
description: "SSD1351 OLED Display"
...
displays with ESPHome. This component is for displays that are connected via the 4-Wire [SPI bus]({{< ref "components/spi#spi" >}}).

![SSD1351 OLED Display](../images/ssd1351-full.jpg)
...
- **cs_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin on the ESP that that the CS line is connected to.
...
Add a `color:` section to your YAML configuration; please see [color]({{< ref "components/display/_index#config-color" >}}) for more detail on this configuration section.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/ssd1351.md)
