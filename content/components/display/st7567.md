---
description: "ST7567 LCD Graphic Display"
...
Note that this component is for displays that are connected via the [st7567-i2c]({{< ref "components/display/st7567#st7567-i2c" >}}) (see [I²C Bus]({{< ref "components/i2c#i2c" >}}))
or 3-Wire or 4-Wire [st7567-spi]({{< ref "components/display/st7567#st7567-spi" >}}) (see [SPI bus]({{< ref "components/spi#spi" >}})).
It's a monochrome LCD graphic display.

![ST7567A based LCD Graphic Display (I²C)](../images/st7567-full.jpg)
...
Connect `SDA` and `SCL` pins on a module to pins you chose for the [I²C Bus]({{< ref "components/i2c#i2c" >}}).
...
- **address** (*Optional*, int): Manually specify the [I²C]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3F.
...
Connect `D0` to the `CLK` pin you chose for the [SPI bus]({{< ref "components/spi#spi" >}}), connect `D1` to the `MOSI` pin and `DC` and `CS`
...
- **cs_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The Chip Select (CS) pin.
- **reset_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The RESET pin. Defaults to not connected.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/st7567.md)
