...
Note that this component is for displays that are connected via the [I²C Bus](components/i2c#i2c) (see [Over I²C](components/display/st7567#st7567-i2c))
or 3-Wire or 4-Wire [SPI bus](components/spi#spi) (see [Over SPI](components/display/st7567#st7567-spi)).
...
Connect `SDA` and `SCL` pins on a module to pins you chose for the [I²C Bus](components/i2c#i2c).
...
- **address** (*Optional*, int): Manually specify the [I²C](components/i2c#i2c) address of the display. Defaults to 0x3F.
...
- **cs_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The Chip Select (CS) pin.
- **reset_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The RESET pin. Defaults to not connected.
