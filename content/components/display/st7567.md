...
Note that this component is for displays that are connected via the [Over I²C]({{< ref "components/display/st7567#st7567-i2c" >}}) (see [I²C Bus]({{< ref "components/i2c#i2c" >}}))
or 3-Wire or 4-Wire [Over SPI]({{< ref "components/display/st7567#st7567-spi" >}}) (see [SPI Bus]({{< ref "components/spi#spi" >}})).
...
- **address** (*Optional*, int): Manually specify the [I²C Bus]({{< ref "components/i2c#i2c" >}}) address of the display. Defaults to 0x3F.
