...
Note that this component is for displays that are connected via the :ref:`I²C Bus <i2c>` (see [Over I²C]({{< ref "components/display/st7567#st7567-i2c" >}}))
or 3-Wire or 4-Wire :ref:`SPI bus <spi>` (see [Over SPI]({{< ref "components/display/st7567#st7567-spi" >}})).
