...
Note that this component is for displays that are connected via the [I²C Bus]({{< ref "components/i2c#i2c" >}}) (see :ref:`st7567-i2c`)
or 3-Wire or 4-Wire [SPI bus]({{< ref "components/spi#spi" >}}) (see :ref:`st7567-spi`).
