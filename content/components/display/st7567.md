...
Note that this component is for displays that are connected via the [I²C Bus](components/i2c#i2c) (see [Over I²C]({{< ref "components/display/st7567#st7567-i2c" >}}))
or 3-Wire or 4-Wire [SPI bus](components/spi#spi) (see [Over SPI]({{< ref "components/display/st7567#st7567-spi" >}})).
