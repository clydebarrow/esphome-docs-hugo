...
{{< warning >}}
This component has been made redundant since the ST7735 is now supported by the [ILI9XXX component]({{< ref "components/display/ili9xxx#ili9xxx" >}}). It is recommended
