...
{{< warning >}}
This component has been made redundant since the ST7735 is now supported by the [ILI9XXX component](components/display/ili9xxx#ili9xxx). It is recommended
...
- **update_interval** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): Time between display updates. Default is 1s.
