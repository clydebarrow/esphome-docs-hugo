...
![ST7735 Display](../images/st7735.jpg)
*ST7735 Display*


{{< warning >}}
This component has been made redundant since the ST7735 is now supported by the [Models]({{< ref "components/display/ili9xxx#ili9xxx" >}}). It is recommended
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/st7735.md)
