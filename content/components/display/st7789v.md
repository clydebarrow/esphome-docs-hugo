...
{{< warning >}}
This component has been made redundant since the ST7789V is now supported by the [ILI9XXX component]({{< ref "components/display/ili9xxx#ili9xxx" >}}). It is recommended
...
- **power_supply** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})):{{< docref "/components/power_supply" "power supply" >}}ply>` to connect to
