...
```
{{< note >}}
For more information about the font options see: [display-fonts](#display-fonts).
...
- **power_supply** (*Optional*, [config-id](#config-id)): The {{< docref "/components/power_supply" "power supply" >}} to connect to
