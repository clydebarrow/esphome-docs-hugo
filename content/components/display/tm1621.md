...
- **cs_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin you have the CS line.
- **data_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin you have the DATA line.
- **read_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin you have the READ line.
- **write_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin you have the WRITE line.
