---
description: "TM1621 LCD Display"
...
![TM1621 LCD Display.](../images/tm1621-full.jpg)
*TM1621 LCD Display.*
...
- **cs_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin you have the CS line.
- **data_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin you have the DATA line.
- **read_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin you have the READ line.
- **write_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin you have the WRITE line.
- **lambda** (*Optional*, [Templates]({{< ref "automations/templates#config-lambda" >}})): The lambda to use for rendering the content on the TM1621.
  See [Rendering Lambda]({{< ref "components/display/tm1621#display-tm1621_lambda" >}}) for more information.
...
The TM1621 has a similar API to the fully fledged [Display Rendering Engine]({{< ref "components/display/_index#display-engine" >}}), but it's only a subset as the TM1621
...
```
Please see [Formatted Text]({{< ref "components/display/_index#display-printf" >}}) for a quick introduction into the `printf` formatting rules.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/tm1621.md)
