---
description: "TM1637 7-Segment Display"
...
![TM1637 7-Segment Display.](../images/tm1637-full.jpg)
...
- **lambda** (*Optional*, [lambda]({{< ref "automations/templates#config-lambda" >}})): The lambda to use for rendering the content on the TM1637.
  See [display-tm1637_lambda]({{< ref "components/display/tm1637#display-tm1637_lambda" >}}) for more information.
...
![TM1637 display keyboard connections](../images/tm1637_key_connections.png)
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Set the ID of this sensor.
- **name** (*Optional*, string): The name for the binary sensor.
- **tm1637_id** (*Optional*, :[config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the tm1637 that should be used to scan the keys in case you are using multiple devices.
...
The TM1637 has a similar API to the fully fledged [display-engine]({{< ref "components/display/_index#display-engine" >}}), but it's only a subset as the TM1637
...
![Two TM1637 displays on only 2 control lines](../images/tm1637_2devices.png)
...
![Three TM1637 displays on 3 control lines](../images/tm1637_3plus_devices.png)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/display/tm1637.md)
