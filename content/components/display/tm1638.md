...
- **lambda** (*Optional*, [lambda]({{< ref "automations/templates#config-lambda" >}})): The lambda to use for rendering the content on the TM1638.
  See [display-tm1638_lambda]({{< ref "components/display/tm1638#display-tm1638_lambda" >}}) for more information.
...
The TM1638 has a similar API to the fully fledged [display-engine]({{< ref "components/display/_index#display-engine" >}}), but it's only a subset as the TM1638
...
not all characters can be represented. You can see a full list of characters [at the MAX7219 docs]({{< ref "components/display/max7219#display-max7219_characters" >}}).
