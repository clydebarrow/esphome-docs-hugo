...
- **lambda** (*Optional*, [lambda](automations/templates#config-lambda)): The lambda to use for rendering the content on the TM1638.
  See [Rendering Lambda](components/display/tm1638#display-tm1638_lambda) for more information.
...
The TM1638 has a similar API to the fully fledged [Display Rendering Engine](components/display/_index#display-engine), but it's only a subset as the TM1638
