...
- **lambda** (*Optional*, [lambda](#config-lambda)): The lambda to use for rendering the content on the TM1638.
  See [display-tm1638_lambda](#display-tm1638_lambda) for more information.
...
The TM1638 has a similar API to the fully fledged [display-engine](#display-engine), but it's only a subset as the TM1638
