...
- **root_item_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the root menu item.
...
- **on_enter** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when the menu level (here the root one) is entered. See [display_menu-on_enter]({{< ref "components/display_menu/_index#display_menu-on_enter" >}}).
...
- **on_enter** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when the menu level is entered. See [display_menu-on_enter]({{< ref "components/display_menu/_index#display_menu-on_enter" >}}).
- **on_leave** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when the menu level is not displayed anymore.
  See [display_menu-on_leave]({{< ref "components/display_menu/_index#display_menu-on_leave" >}}).
...
- **select** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): A `select` component managing
  the edited value.
...
- **on_enter** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when the editing mode is activated. See [display_menu-on_enter]({{< ref "components/display_menu/_index#display_menu-on_enter" >}}).
- **on_leave** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
...
- **immediate_edit** (*Optional*, boolean): Whether the item can be immediately edited when
  ...
  Defaults to `false`.
- **number** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): A `number` component managing
...
- **switch** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): A `switch` component managing
  the edited value.
- **value_lambda** (*Optional*, [lambda]({{< ref "automations/templates#config-lambda" >}})):
  Lambda returning a string to be displayed as value. The lambda gets an `it` argument
...
- **on_next** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  ...
  See [display_menu-on_next]({{< ref "components/display_menu/_index#display_menu-on_next" >}}).
- **on_prev** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  ...
  See [display_menu-on_prev]({{< ref "components/display_menu/_index#display_menu-on_prev" >}}).
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the menu to show.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/display_menu/index.md)
