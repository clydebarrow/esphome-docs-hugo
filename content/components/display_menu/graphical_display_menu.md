...
engine such as {{< docref "/components/display/ssd1306" "OLED displays" >}} or {{< docref "/components/display/waveshare_epaper" "E-Paper displays" >}}.
...
- **on_redraw** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
...
{{< note >}}
Pop Up Mode requires that your display makes use of [pages]({{< ref "components/display/_index#display-pages" >}}). If you are using a drawing lambda, without pages, it will not
...
```
{{< note >}}
Ensure that all characters you use in the menu_item_value are available glyphs for your [font]({{< ref "components/font#display-fonts" >}})
