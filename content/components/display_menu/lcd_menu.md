...
like [lcd-gpio]({{< ref "components/display/lcd_display#lcd-gpio" >}}) or [lcd-pcf8574]({{< ref "components/display/lcd_display#lcd-pcf8574" >}}). For the best results the GPIO connection is
...
in your [i2c]({{< ref "components/i2c#i2c" >}}) configuration.
...
- **display_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the LCD display.
...
- [lcd-pcf8574]({{< ref "components/display/lcd_display#lcd-pcf8574" >}})
- [lcd-gpio]({{< ref "components/display/lcd_display#lcd-gpio" >}})
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/display_menu/lcd_menu.md)
