...
The rest of the configuration is described in the [The component provides a menu primarily intended to be controlled either by a rotary encoder]({{< ref "components/display_menu/_index#display_menu" >}}) component.
