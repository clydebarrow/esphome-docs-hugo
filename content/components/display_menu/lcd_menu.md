...
like [lcd-pcf8574](#lcd-pcf8574) or [lcd-gpio](#lcd-gpio). For the best results the GPIO connection is
...
- **display_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the LCD display.
