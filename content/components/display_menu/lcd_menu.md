...
in your [I²C Bus](components/i2c#i2c) configuration.
...
The rest of the configuration is described in the [Display Menu](components/display_menu/_index#display_menu) component.
