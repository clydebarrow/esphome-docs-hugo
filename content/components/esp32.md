...
- **framework** (*Optional*): Options for the underlying framework used by ESPHome. See [esp32-arduino_framework](#esp32-arduino_framework)
  and [esp32-espidf_framework](#esp32-espidf_framework).
...
- **advanced** (*Optional*, mapping): See [esp32-advanced_configuration](#esp32-advanced_configuration) below.
