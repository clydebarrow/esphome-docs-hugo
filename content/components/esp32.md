...
- **framework** (*Optional*): Options for the underlying framework used by ESPHome. See [Arduino framework](components/esp32#esp32-arduino_framework)
  and [ESP-IDF framework](components/esp32#esp32-espidf_framework).
...
- **advanced** (*Optional*, mapping): See [Advanced Configuration](components/esp32#esp32-advanced_configuration) below.
