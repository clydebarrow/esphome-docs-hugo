...
- **model** (*Optional*, :ref:`esp32_ble_server-value`): The model name of the device. Defaults to the project's name defined in the [core configuration]({{< ref "components/esphome#esphome-configuration_variables" >}}) if present, otherwise to the friendly name of the `board` chosen in the [core configuration]({{< ref "components/esphome#esphome-creators_project" >}}).
...
- **firmware_version** (*Optional*, :ref:`esp32_ble_server-value`): The firmware version of the device. Defaults to the project's version defined in the [core configuration]({{< ref "components/esphome#esphome-creators_project" >}}) if present, otherwise to the ESPHome version.
...
- **on_write** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An action to be performed when the characteristic is written to. The characteristic must have the `write` property. See :ref:`esp32_ble_server-characteristic-on_write`.
...
- **value** (**Required**, :ref:`esp32_ble_server-value`): The value of the descriptor. [templatable]({{< ref "automations/templates#config-templatable" >}}) values are not allowed. In order to set the value of a descriptor dynamically, use the :ref:`esp32_ble_server-descriptor-set_value` action.
