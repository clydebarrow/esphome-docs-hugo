...
- **authorizer** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): A {{< docref "binary_sensor/index" "binary sensor" >}} to authorize with.
...
- **status_indicator** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): An {{< docref "output/index" "output" >}} to display feedback to the user.
