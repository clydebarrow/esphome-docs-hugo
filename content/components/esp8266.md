...
- `GPIO17` additionally has an ADC connected to it. See the [/components/sensor/adc]({{< ref "/components/sensor/adc" >}})
...
- [esphome]({{< ref "esphome/" >}})
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/esp8266.md)
