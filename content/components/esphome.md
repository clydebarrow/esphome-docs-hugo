...
- **name** (**Required**, string): This is the name of the node. It
  ...
  See [esphome-changing_node_name]({{< ref "components/esphome#esphome-changing_node_name" >}}).
...
- **platformio_options** (*Optional*, mapping): Additional options to pass over to PlatformIO in the
  platformio.ini file. See [esphome-platformio_options]({{< ref "components/esphome#esphome-platformio_options" >}}).
- **includes** (*Optional*, list of files): A list of C/C++ files to include in the (auto-generated) `main` file.
  ...
  See [esphome-includes]({{< ref "components/esphome#esphome-includes" >}}).
- **libraries** (*Optional*, list of libraries): A list of libraries to include in the project. See
  [esphome-libraries]({{< ref "components/esphome#esphome-libraries" >}}).
...
- **name_add_mac_suffix** (*Optional*, boolean): Appends the last 3 bytes of the mac address of the device to
  ...
  See [esphome-mac_suffix]({{< ref "components/esphome#esphome-mac_suffix" >}}).
- **project** (*Optional*): ESPHome Creator's Project information. See [esphome-creators_project]({{< ref "components/esphome#esphome-creators_project" >}}).
...
- **min_version** (*Optional*, string): The minimum ESPHome version required to compile this configuration.
  See [esphome-min_version]({{< ref "components/esphome#esphome-min_version" >}}).
...
- **on_boot** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  when the node starts. See [esphome-on_boot]({{< ref "components/esphome#esphome-on_boot" >}}).
- **on_shutdown** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
  right before the node shuts down. See [esphome-on_shutdown]({{< ref "components/esphome#esphome-on_shutdown" >}}).
...
- **priority** (*Optional*, float): The priority to execute your custom shutdown code. A higher value
  ...
  Defaults to `600`. For priority values refer to the list in the [esphome-on_boot]({{< ref "components/esphome#esphome-on_boot" >}}) section.
...
```
- **flash_write_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Customize the frequency in which data is
