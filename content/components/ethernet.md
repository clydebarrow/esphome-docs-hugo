...
- **mdc_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The MDC pin of the board.
  Usually this is `GPIO23`.
- **mdio_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The MDIO pin of the board.
...
- **clk_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The SPI clock pin.
- **mosi_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The SPI MOSI pin.
- **miso_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The SPI MISO pin.
- **cs_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The SPI chip select pin.
- **interrupt_pin** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The interrupt pin.
  This variable is **required** for older frameworks. See below.
- **reset_pin** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The reset pin.
- **clock_speed** (*Optional*, float): The SPI clock speed.
  ...
  Default: `26.67MHz`.
- **polling_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): If `interrupt_pin` is not set,
