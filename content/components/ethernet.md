...
- **mdc_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The MDC pin of the board.
  Usually this is `GPIO23`.
- **mdio_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The MDIO pin of the board.
...
- **power_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin controlling the
  power/reset status of the Ethernet controller. Leave unspecified for no power pin (default).

### SPI configuration variables:

- **clk_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The SPI clock pin.
- **mosi_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The SPI MOSI pin.
- **miso_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The SPI MISO pin.
- **cs_pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The SPI chip select pin.
- **interrupt_pin** (*Optional*, [Pin](guides/configuration-types#config-pin)): The interrupt pin.
  This variable is **required** for older frameworks. See below.
- **reset_pin** (*Optional*, [Pin](guides/configuration-types#config-pin)): The reset pin.
- **clock_speed** (*Optional*, float): The SPI clock speed.
  ...
  Default: `26.67MHz`.
- **polling_interval** (*Optional*, [Time](guides/configuration-types#config-time)): If `interrupt_pin` is not set,
