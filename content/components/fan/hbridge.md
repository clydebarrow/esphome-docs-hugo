...
- **pin_a** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the
  [float output]({{< ref "components/output/_index#output" >}}) connected to Pin A (alternatively IN1, etc.) of the h-bridge.
- **pin_b** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the
  [float output]({{< ref "components/output/_index#output" >}}) connected to Pin B (alternatively IN2, etc.) of the h-bridge.
- **enable_pin** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the
