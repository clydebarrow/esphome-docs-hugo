...
- **pin_a** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the
  [Output Component]({{< ref "components/output/_index#output" >}}) connected to Pin A (alternatively IN1, etc.) of the h-bridge.
- **pin_b** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the
  [Output Component]({{< ref "components/output/_index#output" >}}) connected to Pin B (alternatively IN2, etc.) of the h-bridge.
- **enable_pin** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the
  [Output Component]({{< ref "components/output/_index#output" >}}) connected to the Enable pin of the h-bridge (if h-bridge uses enable).
