...
These fonts can be used in ESPHome's [own rendering engine]({{< ref "components/display/_index#display-engine" >}}) or in the :doc:`LVGL Graphics </c[LVGL Graphics ]({{< relref "/components/lvgl/index" >}})
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID with which you will be able to reference the font later
...
- [display-engine]({{< ref "components/display/_index#display-engine" >}})
