...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Give the global variable an ID so that you can refer
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The [config-id]({{< ref "guides/configuration-types#config-id" >}}) of the global variable to set.
