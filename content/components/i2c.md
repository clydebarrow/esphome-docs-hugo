...
- **sda** (*Optional*, [Pin](guides/configuration-types#config-pin)): The pin for the data line of the I²C bus.
  Defaults to the default of your board (usually GPIO21 for ESP32 and GPIO4 for ESP8266).
- **scl** (*Optional*, [Pin](guides/configuration-types#config-pin)): The pin for the clock line of the I²C bus.
...
- **timeout** (*Optional*, [Time](guides/configuration-types#config-time)): Set the I²C bus timeout.
