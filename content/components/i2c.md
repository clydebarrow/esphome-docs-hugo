...
- **sda** (*Optional*, [config-pin](#config-pin)): The pin for the data line of the I²C bus.
  Defaults to the default of your board (usually GPIO21 for ESP32 and GPIO4 for ESP8266).
- **scl** (*Optional*, [config-pin](#config-pin)): The pin for the clock line of the I²C bus.
...
- **timeout** (*Optional*, [config-time](#config-time)): Set the I²C bus timeout.
...
- **id** (*Optional*, [config-id](#config-id)): Manually specify the ID for this I²C bus if you need multiple I²C buses.
