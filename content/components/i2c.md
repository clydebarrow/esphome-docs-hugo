...
- **sda** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin for the data line of the I²C bus.
  Defaults to the default of your board (usually GPIO21 for ESP32 and GPIO4 for ESP8266).
- **scl** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin for the clock line of the I²C bus.
...
- **timeout** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): Set the I²C bus timeout.
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this I²C bus if you need multiple I²C buses.
...
- :apiref:`i2c/i2c.h`
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/i2c.md)
