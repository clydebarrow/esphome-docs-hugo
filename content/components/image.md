...
For showing images downloaded at runtime, take a look at the [Online Image Component]({{< ref "components/online_image#online_image" >}}) component.
...
Images may be used in LVGL configurations wherever an image is required. See the [LVGL ]({{< relref "/components/lvgl/index" >}}) documentation for more information.
