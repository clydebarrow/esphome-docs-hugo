...
Images may be used in LVGL configurations wherever an image is required. See the {{< docref "/components/lvgl" "LVGL" >}} documentation for more information.
