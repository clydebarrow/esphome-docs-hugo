...
- **interval** (**Required**, [config-time](#config-time)): The interval to execute the action with.
- **startup_delay** (*Optional*, [config-time](#config-time)): An optional startup delay - defaults to zero.
