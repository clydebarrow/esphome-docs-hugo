...
- **transition_length** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}}), [templatable](automations/templates#config-templatable)): The length of the
...
- **transition_length** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}}), [templatable](automations/templates#config-templatable)): The length of the
  transition if the light supports it.
- **flash_length** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}}), [templatable](automations/templates#config-templatable)): If set, will flash the
...
- **uart_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the [UART Component](components/uart#uart). Useful if
