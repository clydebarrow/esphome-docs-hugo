...
- **output** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the binary [Output Component]({{< ref "components/output/_index#output" >}}) to use for this light.
