...
- **cold_white** (**Required**, [config-id](#config-id)): The id of the float [output](#output) to use for the cold white channel.
- **warm_white** (**Required**, [config-id](#config-id)): The id of the float [output](#output) to use for the warm white channel.
