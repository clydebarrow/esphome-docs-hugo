...
[Output Component]({{< ref "components/output/_index#output" >}}) (one for each channel). The two channels
...
the [``light.turn_on`` Action]({{< ref "components/light/_index#light-turn_on_action" >}}).
