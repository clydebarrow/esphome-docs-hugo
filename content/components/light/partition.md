...
- **segments** (**Required**, list): A list of segments included in this partition.
  ...
  *For addressable segments:*
  ...
  - **id** (**Required**, [config-id](#config-id)): The ID of the addressable light to be controlled by this segment.
  ...
  *For single light segments:*
  ...
  - **single_light_id** (**Required**, [config-id](#config-id)): The ID of a single addressable or non-addressable light.
...
See [light-addressable_set_action](#light-addressable_set_action) for that.
