...
{{< img src="lightwaverf.jpg" alt="Image" caption="LightwaveRF switches are very common in UK automation. They allow control of lights, sockets, relays and more via RF remote or via a hub." width="40.0%" class="center" >}}
...
- **read_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin that the receiver is connected to
- **write_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): the pin that the transmitter is connected to
