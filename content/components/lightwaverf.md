...
- **read_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin that the receiver is connected to
- **write_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): the pin that the transmitter is connected to
