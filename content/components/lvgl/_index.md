...
To use LVGL with a [display]({{< ref "components/_index#display-hw" >}}) in ESPHome, you'll need an ESP32 or RP2040. PSRAM is not a strict requirement but it is generally recommended, especially for large color displays.
...
Widgets can be assigned with an [automations]({{< ref "automations/_index#automation" >}}) so that they can be referenced in [config-id]({{< ref "guides/configuration-types#config-id" >}}).
...
The following configuration variables apply to the main `lvgl` component, in order to establish the principal operating conditions. Some [styling options]({{< ref "components/lvgl/_index#lvgl-theme" >}}) can be set at this level too, but only for inheritance purposes.

**Configuration variables:**

- **displays** (*Optional*, list, [config-id]({{< ref "guides/configuration-types#config-id" >}})): A list of display IDs where LVGL should perform rendering based on its configuration. This may be omitted if there is a single display configured, which will be used automatically.
- **touchscreens** (*Optional*, list): A list of touchscreens interacting with the LVGL widgets on the display. If you configure a single touchscreen it will be used automatically, and this config entry will not be required.
    - **touchscreen_id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): ID of a touchscreen configuration related to a display.
...
- **encoders** (*Optional*, list): A list of rotary encoders interacting with the LVGL widgets on the display.
    ...
    - **initial_focus** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): An optional ID for a widget to be given focus on startup (especially useful if there is only one focusable widget.)
    - **enter_button** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `ENTER` key.
    - **sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [/components/sensor/rotary_encoder]({{< ref "/components/sensor/rotary_encoder" >}})oder`; or a list with buttons for left/right interaction with the widgets:
        - **left_button** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `LEFT` key.
        - **right_button** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `RIGHT` key.
...
- **keypads** (*Optional*, list): A list of keypads interacting with the LVGL widgets on the display.
    - **group** (*Optional*, string): A name for a group of widgets which will interact with the the input device. See the [common properties ]({{< relref "/components/lvgl/widgets" >}}) of the widgets for more information on groups.
    - **up** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `UP` key.
    - **down** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `DOWN` key.
    - **right** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `RIGHT` key.
    - **left** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `LEFT` key.
    - **esc** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `ESC` key.
    - **del** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `DEL` key.
    - **backspace** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `BACKSPACE` key.
    - **enter** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `ENTER` key.
    - **next** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `NEXT` key.
    - **prev** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `PREV` key.
    - **home** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `HOME` key.
    - **end** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID [Binary Sensor ]({{< relref "/components/binary_sensor/index" >}})dex>`, to be used as `END` key.
...
- **disp_bg_image** (*Optional*, [lvgl-widget-image]({{< ref "components/lvgl/widgets#lvgl-widget-image" >}})):  The ID of an existing image configuration, to be used as background wallpaper. To change the image at runtime use the `lvgl.update` action. Also see [image]({{< ref "components/image#display-image" >}}) for a note regarding supported image formats. May also be set to `none` to clear the background image.`
...
- **gradients** (*Optional*, list): A list of gradient definitions to use in *bg_grad* styles. See [below]({{< ref "components/lvgl/_index#lvgl-gradients" >}}) for more details.
...
- **pages** (*Optional*, list): A list of page IDs. Each page acts as a parent for widgets placed on it. May not be used with `widgets` (above). Options for each page:
    - **skip** (*Optional*, boolean): Option to skip this page when navigating between them with [lvgl-page-next-previous-action]({{< ref "components/lvgl/_index#lvgl-page-next-previous-action" >}}).
    ...
    - All other options from [lvgl-styling]({{< ref "components/lvgl/_index#lvgl-styling" >}}) to be applied to this page.
- **page_wrap** (*Optional*, boolean): Wrap from the last to the first page when navigating between them with [lvgl-page-next-previous-action]({{< ref "components/lvgl/_index#lvgl-page-next-previous-action" >}}). Defaults to `true`.
- **top_layer** (*Optional*, list): A special kind of *Always on Top* page, which acts as a parent for widgets placed on it. It's shown above all the pages, which may be useful for widgets which always need to be visible.
    ...
    - All other options from [lvgl-styling]({{< ref "components/lvgl/_index#lvgl-styling" >}}) to be applied to this page.
- **layout** (*Optional*): See [lvgl-layouts]({{< ref "components/lvgl/_index#lvgl-layouts" >}}) for details. Defaults to `NONE`.
- All other options from [lvgl-styling]({{< ref "components/lvgl/_index#lvgl-styling" >}}) to be applied to all widgets directly.
...
Check out [lvgl-cookbook-iconbatt]({{< ref "cookbook/lvgl#lvgl-cookbook-iconbatt" >}}), [lvgl-cookbook-iconstat]({{< ref "cookbook/lvgl#lvgl-cookbook-iconstat" >}}) and [lvgl-cookbook-icontext]({{< ref "cookbook/lvgl#lvgl-cookbook-icontext" >}}) in the Cookbook for examples which demonstrate how to use icons and text with TrueType/OpenType fonts.
...
- **bg_color** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color for the background of the widget. Defaults to `0xFFFFFF` (white).
- **bg_grad** (*Optional*, [gradient]({{< ref "components/lvgl/_index#lvgl-gradients" >}})): A gradient to apply to the background.
- **bg_grad_color** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color to make the background gradually fade to. Defaults to `0` (black).
...
- **bg_image_src** (*Optional*, [image]({{< ref "components/image#display-image" >}})):  The ID of an existing image configuration, to show as the background of the widget.
- **bg_image_opa** (*Optional*, [opacity]({{< ref "components/lvgl/_index#lvgl-opacity" >}})): Opacity of the background image of the widget.
- **bg_image_recolor** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color to mix with every pixel of the background image of the widget.
...
- **border_color** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color to draw borders of the widget. Defaults to `0` (black).
...
- **outline_color** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color used to draw an outline around the widget. Defaults to `0` (black).
...
- **shadow_color** (*Optional*, [color]({{< ref "components/lvgl/_index#lvgl-color" >}})): Color used to create a drop shadow under the widget. Defaults to `0` (black).
...
```
Additionally, you can change the styles based on the [state]({{< ref "components/lvgl/widgets#lvgl-widgetproperty-state" >}}) property of the widgets or their parts. If you want to set a property for all states (e.g. red background color) just set it for the default state at the root of the widget. If the widget can't find a property for its current state it will fall back to this.
...
Check out [lvgl-cookbook-weather]({{< ref "cookbook/lvgl#lvgl-cookbook-weather" >}}), [lvgl-cookbook-grid]({{< ref "cookbook/lvgl#lvgl-cookbook-grid" >}}) and [lvgl-cookbook-flex]({{< ref "cookbook/lvgl#lvgl-cookbook-flex" >}}) in the Cookbook for examples which demonstrate how to automate widget positioning, potentially reducing the size of your device's YAML configuration, and saving you from lots of manual calculations.
...
In a grid layout, *all the widgets placed on the grid* will get some additional configuration variables to help with placement:
    ...
    - **grid_cell_x_align** (*Optional*, string): How to align the widget horizontally within the cell. Can also be applied through [lvgl-styling]({{< ref "components/lvgl/_index#lvgl-styling" >}}). Possible options below.
    - **grid_cell_y_align** (*Optional*, string): How to align the widget vertically within the cell. Can also be applied through [lvgl-styling]({{< ref "components/lvgl/_index#lvgl-styling" >}}). Possible options below.
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID with which you will be able to reference the gradient later.
...
- **stops** (**Required**, list): A list of at least 2 color stop points. Each stop point has the following options:
    - **color** (**Required**, [Color]({{< ref "components/lvgl/_index#lvgl-color" >}})): The color of the stop point.
...
Widgets support [general or specific]({{< ref "components/lvgl/widgets#lvgl-automation-actions" >}}) actions - see the :doc:`/components/lvgl/widgets`[/components/lvgl/widgets]({{< ref "/components/lvgl/widgets" >}})
...
- **show_snow** (*Optional*, boolean): When paused, display random colored pixels across the entire screen in order to minimize screen burn-in, to relief the tension put on each individual pixel. See [lvgl-cookbook-antiburn]({{< ref "cookbook/lvgl#lvgl-cookbook-antiburn" >}}) for an example which demonstrates how to use this.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/lvgl/index.md)
