...
Widgets can be assigned with an [ID]({{< ref "guides/configuration-types#config-id" >}}) so that they can be referenced in :ref:`automations <automation>`.
...
Widgets support :ref:`general or specific <lvgl-automation-actions>` actions - see the {{< docref "/components/lvgl/widgets" >}} section for more information.
