...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Give the mapping an ID so that you can refer
...
- `color`: Maps to a predefined [config-color]({{< ref "components/display/_index#config-color" >}}). The values should each be a color ID.
