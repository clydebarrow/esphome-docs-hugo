...
([datasheet](https://datasheets.maximintegrated.com/en/ds/MAX6956.pdf)) in ESPHome. It uses [I²C Bus](components/i2c#i2c) for communication.
...
Any option accepting a [Pin Schema](guides/configuration-types#config-pin_schema) can theoretically be used.

## Component/Hub

{{< img src="max6956.jpg" alt="Image" caption="MAX6956 I/O Expander." width="80.0%" class="center" >}}

The `max6956` is an [I²C Bus](components/i2c#i2c) slave. Its address is configured using A0 and A1 hardware pins from 0x40 to 0x4F.
