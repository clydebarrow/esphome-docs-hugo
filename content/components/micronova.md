...
![.. figure:: images/micronova_serial_layout.png](../images/micronova_serial.png)
...
![Optocoupler interface circuit (credit: philibertc)](../images/micronova_optocouplers.png)
...
- **enable_rx_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): Output pin to be used to switch the line between RX and TX.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/micronova.md)
