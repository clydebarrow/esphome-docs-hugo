...
- **microphone** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})):[microphone ]({{< relref "/components/microphone/index" >}})dex>` to use for input.
...
**id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The microphone to control. Defaults to the only one in YAML.
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The microphone to check. Defaults to the only one in YAML.
