...
- **i2s_audio_id** (*Optional*, [ID](guides/configuration-types#config-id)): The ID of the [I²S Audio](components/i2s_audio#i2s_audio) you wish to use for this microphone.
