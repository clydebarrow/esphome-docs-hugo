...
This is an [Action](automations/actions#config-action) seting a number to its minimum value, given
...
This is an [Action](automations/actions#config-action) seting a number to its maximum value (given
