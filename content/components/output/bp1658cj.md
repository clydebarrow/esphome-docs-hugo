...
[Component/Hub](components/output/bp1658cj#bp1658cj-component) as a float output.
...
- **bp1658cj_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/bp1658cj#bp1658cj-component).
