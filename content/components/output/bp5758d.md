...
[Component/Hub](components/output/bp5758d#bp5758d-component) as a float output.
...
- **bp5758d_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/bp5758d#bp5758d-component).
