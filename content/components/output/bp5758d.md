...
[individual output channels](components/output/bp5758d#bp5758d-output).
...
-  **data_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin used for DATA.
-  **clock_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin which CLK is
   connected to.
