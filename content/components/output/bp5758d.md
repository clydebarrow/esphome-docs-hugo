...
[Output]({{< ref "components/output/bp5758d#bp5758d-output" >}}).
...
[Component/Hub]({{< ref "components/output/bp5758d#bp5758d-component" >}}) as a float output.
...
- **bp5758d_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/bp5758d#bp5758d-component" >}}).
