...
[bp5758d-component](#bp5758d-component) as a float output.
...
- **bp5758d_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the
  [bp5758d-component](#bp5758d-component).
...
at the same time, but it is not encourage. Therefore, the [rgbw_color_interlock](#rgbw_color_interlock)
