...
- **id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID used for code generation.
- **gp8403_id** (*Optional*, [ID](guides/configuration-types#config-id)): The ID of the GP8403 component.
...
- All other options from [Base Output Configuration](components/output/_index#config-output).
