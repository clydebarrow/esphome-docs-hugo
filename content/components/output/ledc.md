...
- **pin** (**Required**, [Pin](guides/configuration-types#config-pin)): The pin to use LEDC on. Can only be GPIO0-GPIO33.
...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The ID of the LEDC output to change.
