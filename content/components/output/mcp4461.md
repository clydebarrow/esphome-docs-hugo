...
The MCP4461 output component exposes 8 MCP4461 (wiper-)channels of a global [MCP4461](components/output/mcp4461#mcp4461-component) as float outputs.
...
- **mcp4461_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [MCP4461](components/output/mcp4461#mcp4461-component).
...
- All other configuration variables from [Output](components/output/_index#config-output).
