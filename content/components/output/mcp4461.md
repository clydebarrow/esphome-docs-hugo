...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this output component.
...
The MCP4461 output component exposes 8 MCP4461 (wiper-)channels of a global [The MCP4461 output component enables the use of an 8‑bit external quad digital potentiometer/rheostat via I²C. See the [MCP4461 Datasheet](https://www.microchip.com/en-us/product/mcp4461) for more information.]({{< ref "components/output/mcp4461#mcp4461-component" >}}) as float outputs.
...
- **mcp4461_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [The MCP4461 output component enables the use of an 8‑bit external quad digital potentiometer/rheostat via I²C. See the [MCP4461 Datasheet](https://www.microchip.com/en-us/product/mcp4461) for more information.]({{< ref "components/output/mcp4461#mcp4461-component" >}}).
...
- All other configuration variables from [Base Output Configuration]({{< ref "components/output/_index#config-output" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/mcp4461.md)
