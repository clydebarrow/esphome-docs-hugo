...
in order to have analog outputs on any board by using [I²C]({{< ref "components/i2c#i2c" >}}). Devices default address is `0x60`.
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this output component.
...
The MCP4728 output component exposes 4 MCP4728 channels of a global [MCP4728]({{< ref "components/output/mcp4728#mcp4728-component" >}}) as float outputs.
...
- **mcp4728_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [MCP4728]({{< ref "components/output/mcp4728#mcp4728-component" >}}).
