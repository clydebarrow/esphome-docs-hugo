...
in order to have analog outputs on any board by using [I²C Bus]({{< ref "components/i2c#i2c" >}}). Devices default address is `0x60`.
...
The MCP4728 output component exposes 4 MCP4728 channels of a global [The MCP4728 output component allows to use `12bit external quad DAC]({{< ref "components/output/mcp4728#mcp4728-component" >}}) as float outputs.
...
- **mcp4728_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [The MCP4728 output component allows to use `12bit external quad DAC]({{< ref "components/output/mcp4728#mcp4728-component" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/mcp4728.md)
