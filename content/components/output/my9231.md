...
[individual output channels](components/output/my9231#my9231-output).
...
-  **data_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin which DI is connected
   to.
-  **clock_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin which DCKI is
   connected to.
