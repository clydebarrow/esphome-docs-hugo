---
description: "MY9231/MY9291 LED driver"
...
[individual output channels]({{< ref "components/output/my9231#my9231-output" >}}).
...
-  **data_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin which DI is connected
   to.
-  **clock_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin which DCKI is
   connected to.
...
[my9231-component]({{< ref "components/output/my9231#my9231-component" >}}) as a float output.
...
- **my9231_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [my9231-component]({{< ref "components/output/my9231#my9231-component" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/my9231.md)
