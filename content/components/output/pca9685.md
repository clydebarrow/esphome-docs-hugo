...
[PCA9685 Output]({{< ref "components/output/pca9685#pca9685-output" >}}).
...
[Component/Hub]({{< ref "components/output/pca9685#pca9685-component" >}}) as a float
output.
...
- **pca9685_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/pca9685#pca9685-component" >}}).
