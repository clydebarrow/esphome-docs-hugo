...
[individual output channels](components/output/pca9685#pca9685-output).
...
[PCA9685 hub](components/output/pca9685#pca9685-component) as a float
output.
...
- **pca9685_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [PCA9685 hub](components/output/pca9685#pca9685-component).
