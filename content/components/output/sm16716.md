---
description: "SM16716 LED driver"
...
[individual output channels]({{< ref "components/output/sm16716#sm16716-output" >}}).
...
[sm16716-component]({{< ref "components/output/sm16716#sm16716-component" >}}) as a float output.
...
- **sm16716_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [sm16716-component]({{< ref "components/output/sm16716#sm16716-component" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/sm16716.md)
