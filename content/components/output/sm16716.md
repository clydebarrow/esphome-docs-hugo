...
[Component/Hub]({{< ref "components/output/sm16716#sm16716-component" >}}) as a float output.
...
- **sm16716_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/sm16716#sm16716-component" >}}).
