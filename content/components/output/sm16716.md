...
[Component/Hub](components/output/sm16716#sm16716-component) as a float output.
...
- **sm16716_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/sm16716#sm16716-component).
