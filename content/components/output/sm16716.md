...
[sm16716-component](#sm16716-component) as a float output.
...
- **sm16716_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the
  [sm16716-component](#sm16716-component).
