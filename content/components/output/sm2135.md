...
[sm2135-component]({{< ref "components/output/sm2135#sm2135-component" >}}) as a float output.
...
- **sm2135_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [sm2135-component]({{< ref "components/output/sm2135#sm2135-component" >}}).
