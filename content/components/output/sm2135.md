...
[Component/Hub](components/output/sm2135#sm2135-component) as a float output.
...
- **sm2135_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/sm2135#sm2135-component).
