...
[individual output channels]({{< ref "components/output/sm2135#sm2135-output" >}}).
...
-  **data_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin used for MOSI.
-  **clock_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin which SCLK is
   connected to.
...
[Component/Hub]({{< ref "components/output/sm2135#sm2135-component" >}}) as a float output.
...
- **sm2135_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/sm2135#sm2135-component" >}}).
...
at the same time. Therefore, the [Color Interlock]({{< ref "components/light/rgbw#rgbw_color_interlock" >}}) should be set to true
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/sm2135.md)
