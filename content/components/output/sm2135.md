...
[sm2135-component](#sm2135-component) as a float output.
...
- **sm2135_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the
  [sm2135-component](#sm2135-component).
...
at the same time. Therefore, the [rgbw_color_interlock](#rgbw_color_interlock) should be set to true
