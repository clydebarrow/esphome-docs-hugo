...
[individual output channels](components/output/sm2135#sm2135-output).
...
-  **data_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin used for MOSI.
-  **clock_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin which SCLK is
   connected to.
