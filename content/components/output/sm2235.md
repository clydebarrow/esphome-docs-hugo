...
[Component/Hub](components/output/sm2235#sm2235-component) as a float output.
...
- **sm2235_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/sm2235#sm2235-component).
