...
[individual output channels]({{< ref "components/output/sm2235#sm2235-output" >}}).
...
[sm2235-component]({{< ref "components/output/sm2235#sm2235-component" >}}) as a float output.
...
- **sm2235_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [sm2235-component]({{< ref "components/output/sm2235#sm2235-component" >}}).
