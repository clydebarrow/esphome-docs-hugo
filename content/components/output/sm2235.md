...
[Output]({{< ref "components/output/sm2235#sm2235-output" >}}).
...
[Component/Hub]({{< ref "components/output/sm2235#sm2235-component" >}}) as a float output.
...
- **sm2235_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/sm2235#sm2235-component" >}}).
...
- [/components/output/sm2335]({{< ref "/components/output/sm2335" >}})
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/sm2235.md)
