...
[sm2235-component](#sm2235-component) as a float output.
...
- **sm2235_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the
  [sm2235-component](#sm2235-component).
