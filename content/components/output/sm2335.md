...
[individual output channels]({{< ref "components/output/sm2335#sm2335-output" >}}).
...
[sm2335-component]({{< ref "components/output/sm2335#sm2335-component" >}}) as a float output.
...
- **sm2335_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [sm2335-component]({{< ref "components/output/sm2335#sm2335-component" >}}).
