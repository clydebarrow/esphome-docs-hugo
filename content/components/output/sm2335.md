...
[Component/Hub](components/output/sm2335#sm2335-component) as a float output.
...
- **sm2335_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
  [Component/Hub](components/output/sm2335#sm2335-component).
