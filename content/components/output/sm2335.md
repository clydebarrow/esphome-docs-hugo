...
[Output]({{< ref "components/output/sm2335#sm2335-output" >}}).
...
[Component/Hub]({{< ref "components/output/sm2335#sm2335-component" >}}) as a float output.
...
- **sm2335_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/output/sm2335#sm2335-component" >}}).
...
at the same time, but it is not encourage. Therefore, the [Color Interlock]({{< ref "components/light/rgbw#rgbw_color_interlock" >}})
...
- [/components/output/sm2235]({{< ref "/components/output/sm2235" >}})
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/output/sm2335.md)
