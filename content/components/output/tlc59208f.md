...
uses [I²C Bus](components/i2c#i2c) for communication.

To use the channels of this components, you first need to setup the
global `tlc59208f` chip and specify its address and id, and then define the
[individual output channels](components/output/tlc59208f#tlc59208f-output).
...
[TLC59208F chip](components/output/tlc59208f#tlc59208f-component) as a float
output.
...
- **tlc59208f_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [TLC59208F chip](components/output/tlc59208f#tlc59208f-component).
