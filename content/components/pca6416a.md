...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this `pca6416a` component.
...
- **pca6416a** (**Required**, [ID](guides/configuration-types#config-id)): The id of the `pca6416a` component of the pin.
