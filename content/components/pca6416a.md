---
description: "PCA6416A I/O Expander"
...
It uses [I²C Bus]({{< ref "components/i2c#i2c" >}}) for communication.
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this `pca6416a` component.
...
- **pca6416a** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the `pca6416a` component of the pin.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/pca6416a.md)
