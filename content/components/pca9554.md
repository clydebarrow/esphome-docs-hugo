---
description: "PCA9554 I/O Expander"
...
[I²C Bus]({{< ref "components/i2c#i2c" >}}) for communication.
...
![PCA9554A I/O Expander chip](../images/pca9554a.jpg)
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this `pca9554` component.
...
- **pca9554** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the `pca9554` component of the pin.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/pca9554.md)
