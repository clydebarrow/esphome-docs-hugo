...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this `pca9554` component.
...
- **pca9554** (**Required**, [ID](guides/configuration-types#config-id)): The id of the `pca9554` component of the pin.
