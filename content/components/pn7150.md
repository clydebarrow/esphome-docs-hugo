...
establishes a connection to the PN7150 via [I²C]({{< ref "components/i2c#i2c" >}}).

![An :ref:`I²C <i2c>` bus must be defined within your device's ESPHome configuration to use the PN7150.](../images/pn7150-full.jpg)
...
independently enabled and disabled by using the corresponding [pn7150-actions]({{< ref "components/pn7150#pn7150-actions" >}}) (see below).
...
- **emulation_message** (*Optional*, string): When scanned by another NFC card/tag reader (such as a smartphone), this
  ...
  tag reader/writer.
- **tag_ttl** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The duration that must elapse after the PN7150 is no longer able to
...
- **on_tag** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when a tag is first read. See
  [pn7150-on_tag]({{< ref "components/pn7150#pn7150-on_tag" >}}).
- **on_tag_removed** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform after a tag is removed. See
  [pn7150-on_tag_removed]({{< ref "components/pn7150#pn7150-on_tag_removed" >}}).
- **on_emulated_tag_scan** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when the PN7150 is
  scanned by another tag reader (such as a smartphone). See [pn7150-on_emulated_tag_scan]({{< ref "components/pn7150#pn7150-on_emulated_tag_scan" >}}).
...
See [pn7150-ndef_reading]({{< ref "components/pn7150#pn7150-ndef_reading" >}}) below for how to use the second `tag` parameter that is provided to this trigger.
