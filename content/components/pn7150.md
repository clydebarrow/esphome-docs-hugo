...
establishes a connection to the PN7150 via [I²C Bus]({{< ref "components/i2c#i2c" >}}).

{{< img src="pn7150-full.jpg" alt="Image" caption="An :ref:`I²C <i2c>` bus must be defined within your device's ESPHome configuration to use the PN7150." width="70.0%" class="center" >}}
...
independently enabled and disabled by using the corresponding [Actions]({{< ref "components/pn7150#pn7150-actions" >}}) (see below).
...
- **dwl_req_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin connected to the PN7150's
  `DWL_REQ` line. Used to invoke the PN7150's firmware update mode; may be used in a future release.
- **irq_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin connected to the PN7150's `IRQ` line.
- **ven_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin connected to the PN7150's `VEN` line.
- **wkup_req_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin connected to the PN7150's
...
- **emulation_message** (*Optional*, string): When scanned by another NFC card/tag reader (such as a smartphone), this
  ...
  tag reader/writer.
- **tag_ttl** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): The duration that must elapse after the PN7150 is no longer able to
...
- **on_tag** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when a tag is first read. See
  [``on_tag`` Trigger]({{< ref "components/pn7150#pn7150-on_tag" >}}).
- **on_tag_removed** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform after a tag is removed. See
  [``on_tag_removed`` Trigger]({{< ref "components/pn7150#pn7150-on_tag_removed" >}}).
- **on_emulated_tag_scan** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when the PN7150 is
  scanned by another tag reader (such as a smartphone). See [``on_emulated_tag_scan`` Trigger]({{< ref "components/pn7150#pn7150-on_emulated_tag_scan" >}}).
...
See [NDEF Reading]({{< ref "components/pn7150#pn7150-ndef_reading" >}}) below for how to use the second `tag` parameter that is provided to this trigger.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/pn7150.md)
