...
establishes a connection to the PN7150 via [I²C](components/i2c#i2c).

{{< img src="pn7150-full.jpg" alt="Image" width="70.0%" class="center" >}}

An [I²C](components/i2c#i2c) bus must be defined within your device's ESPHome configuration to use the PN7150.
...
- **dwl_req_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin connected to the PN7150's
  `DWL_REQ` line. Used to invoke the PN7150's firmware update mode; may be used in a future release.
- **irq_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin connected to the PN7150's `IRQ` line.
- **ven_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin connected to the PN7150's `VEN` line.
- **wkup_req_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The pin connected to the PN7150's
...
- **on_emulated_tag_scan** (*Optional*, [Automation](automations/_index#automation)): An automation to perform when the PN7150 is
