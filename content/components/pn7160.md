...
establishes a connection to the PN7160 via [SPI]({{< ref "components/spi#spi" >}}) or [I²C]({{< ref "components/i2c#i2c" >}}).
...
[SPI bus]({{< ref "components/spi#spi" >}}) or the [I²C bus]({{< ref "components/i2c#i2c" >}}).
