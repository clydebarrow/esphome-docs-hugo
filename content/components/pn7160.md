...
establishes a connection to the PN7160 via [I²C]({{< ref "components/i2c#i2c" >}}) or [SPI]({{< ref "components/spi#spi" >}}).

![Within ESPHome, the PN7160 can be configured to use either the SPI **or** I²C protocol for data communication.](../images/pn716x-full.jpg)
...
independently enabled and disabled by using the corresponding [pn7160-actions]({{< ref "components/pn7160#pn7160-actions" >}}) (see below).
...
The `pn7160_spi` component allows you to use [SPI-equipped]({{< ref "components/spi#spi" >}}) PN7160 NFC controllers with with ESPHome.
...
- **emulation_message** (*Optional*, string): When scanned by another NFC card/tag reader (such as a smartphone), this
  ...
  tag reader/writer.
- **tag_ttl** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The duration that must elapse after the PN7160 is no longer able to
...
- **on_tag** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when a tag is first read. See
  [pn7160-on_tag]({{< ref "components/pn7160#pn7160-on_tag" >}}).
- **on_tag_removed** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform after a tag is removed. See
  [pn7160-on_tag_removed]({{< ref "components/pn7160#pn7160-on_tag_removed" >}}).
- **on_emulated_tag_scan** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform when the PN7160 is
  scanned by another tag reader (such as a smartphone). See [pn7160-on_emulated_tag_scan]({{< ref "components/pn7160#pn7160-on_emulated_tag_scan" >}}).
...
The `pn7160_i2c` component allows you to use [I²C-equipped]({{< ref "components/i2c#i2c" >}}) PN7160 NFC controllers with ESPHome.
...
See [pn7160-ndef_reading]({{< ref "components/pn7160#pn7160-ndef_reading" >}}) below for how to use the second `tag` parameter that is provided to this trigger.
...
ID contained within its NDEF message to Home Assistant using the [api-homeassistant_tag_scanned_action]({{< ref "components/api#api-homeassistant_tag_scanned_action" >}}).
