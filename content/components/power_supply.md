...
- **id** (**Required**, [config-id](#config-id)): The id of the
...
- **enable_time** (*Optional*, [config-time](#config-time)): The time
...
- **keep_on_time** (*Optional*, [config-time](#config-time)): The time the
