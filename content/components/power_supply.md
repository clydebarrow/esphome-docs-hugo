...
- **enable_time** (*Optional*, [Time](guides/configuration-types#config-time)): The time
...
- **keep_on_time** (*Optional*, [Time](guides/configuration-types#config-time)): The time the
