...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The [config-id]({{< ref "guides/configuration-types#config-id" >}}) of the script. Use this to interact with the script
