...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for [seeed_mr24hpc1]({{< ref "seeed_mr24hpc1/" >}})hpc1` component if you need multiple components.
...
- **movement_signs** (*Optional*, int): A value calculated by a built-in algorithm to determine if someone is moving in the current environment.
  ...
  All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_motion_distance** (*Optional*, float): Valid only for [underlying open functions]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  Distance in meters of detected moving target.
  All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_spatial_static_value** (*Optional*, int): Valid only for [underlying open functions]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  ...
  All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_spatial_motion_value** (*Optional*, int): Valid only for [underlying open functions]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  Motion amplitude values, different motion amplitudes cause different electromagnetic wave frequency changes.
  The output range for this value is 0-250.
  All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_motion_speed** (*Optional*, float): Valid only for [underlying open functions]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
...
- **custom_mode** (*Optional*, int): Settings and go to the Custom Mode option. Some of the function modules can only be set up in Custom Mode.
  ...
  All options from [Number]({{< ref "components/number/_index#config-number" >}}).
- **existence_threshold** (*Optional*, int): Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  This corresponds to [custom_spatial_static_value]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-spatial_static" >}}).
  ...
  All options from [Number]({{< ref "components/number/_index#config-number" >}}).
- **motion_threshold** (*Optional*, int): Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  This corresponds to [custom_spatial_motion_value]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-spatial_mtion" >}}).
  ...
  All options from [Number]({{< ref "components/number/_index#config-number" >}}).
- **motion_trigger** (*Optional*, int): Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Number]({{< ref "components/number/_index#config-number" >}}).
- **motion_to_rest** (*Optional*, int): Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Number]({{< ref "components/number/_index#config-number" >}}).
- **custom_unman_time** (*Optional*, int): Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
...
- **unman_time**: Valid only in [standard mode]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-standard_mode" >}}).
  ...
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
- **existence_boundary**: Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
- **motion_boundary**: Valid only in [custom mode settings]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
