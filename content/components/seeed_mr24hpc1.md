...
- **custom_presence_of_detection** (*Optional*, float): Valid only for [.. _seeed_mr24hpc1-standard_mode:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
...
- **movement_signs** (*Optional*, int): A value calculated by a built-in algorithm to determine if someone is moving in the current environment.
  ...
  All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_motion_distance** (*Optional*, float): Valid only for [.. _seeed_mr24hpc1-standard_mode:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  Distance in meters of detected moving target.
  All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_spatial_static_value** (*Optional*, int): Valid only for [.. _seeed_mr24hpc1-standard_mode:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  ...
  All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_spatial_motion_value** (*Optional*, int): Valid only for [.. _seeed_mr24hpc1-standard_mode:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
  Motion amplitude values, different motion amplitudes cause different electromagnetic wave frequency changes.
  The output range for this value is 0-250.
  All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **custom_motion_speed** (*Optional*, float): Valid only for [.. _seeed_mr24hpc1-standard_mode:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-open_function" >}}).
...
- **sensitivity** (*Optional*, int): Valid only in [Switch]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-standard_mode" >}}). Used to adjust the sensitivity of the radar.
...
- **custom_mode** (*Optional*, int): Settings and go to the Custom Mode option. Some of the function modules can only be set up in Custom Mode.
  ...
  All options from [Base Number Configuration]({{< ref "components/number/_index#config-number" >}}).
- **existence_threshold** (*Optional*, int): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  This corresponds to [.. _seeed_mr24hpc1-spatial_mtion:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-spatial_static" >}}).
  ...
  All options from [Base Number Configuration]({{< ref "components/number/_index#config-number" >}}).
- **motion_threshold** (*Optional*, int): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  This corresponds to [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-spatial_mtion" >}}).
  ...
  All options from [Base Number Configuration]({{< ref "components/number/_index#config-number" >}}).
- **motion_trigger** (*Optional*, int): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Base Number Configuration]({{< ref "components/number/_index#config-number" >}}).
- **motion_to_rest** (*Optional*, int): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Base Number Configuration]({{< ref "components/number/_index#config-number" >}}).
- **custom_unman_time** (*Optional*, int): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
...
- **restart** (*Optional*): Restart the device. All options from [Base Button Configuration]({{< ref "components/button/_index#config-button" >}}).
- **custom_set_end** (*Optional*): Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
...
- **scene_mode** (*Optional*): Valid only in [Switch]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-standard_mode" >}}). Used to select a preset scene in standard mode.
...
- **unman_time**: Valid only in [Switch]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-standard_mode" >}}).
  Same as `custom_unman_time`, but this setting is only valid in standard mode.
  All options from [Base Select Configuration]({{< ref "components/select/_index#config-select" >}}).
- **existence_boundary**: Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
  ...
  All options from [Base Select Configuration]({{< ref "components/select/_index#config-select" >}}).
- **motion_boundary**: Valid only in [Configuration variables:]({{< ref "components/seeed_mr24hpc1#seeed_mr24hpc1-custom_mode" >}}).
