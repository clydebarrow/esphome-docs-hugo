...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for [seeed_mr60bha2]({{< ref "seeed_mr60bha2/" >}})bha2` component if you need multiple components.
