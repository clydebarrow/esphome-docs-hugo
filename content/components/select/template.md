...
- **update_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The interval on which to update the select
...
with the [select-set_action]({{< ref "components/select/_index#select-set_action" >}}).
