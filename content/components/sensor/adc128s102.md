...
- **id** (**Required**, [config-id](#config-id)): The id to use for this ADC128S102 component.
...
- **adc128s102_id** (**Required**, [config-id](#config-id)): The id of the parent ADC128S102 component.
