---
description: "ADE7953 Power Sensor"
...
{{< /note >}}
The [I²C Bus]({{< ref "components/i2c#i2c" >}})
or [SPI Bus]({{< ref "components/spi#spi" >}})
...
- **irq_pin** (*Optional*, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin connected to the ADE7935 IRQ line (if connected)
...
Additionally, the device has an :[NTC temperature sensor ]({{< relref "ntc/" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ade7953.md)
