---
description: "ADS1115 4-Channel 16-Bit A/D Converter"
...
individual sensors using the [ADS1115 Sensor Platform]({{< ref "components/sensor/ads1115#ads1115-sensor" >}}).
To use this hub, first setup the [I²C Bus]({{< ref "components/i2c#i2c" >}}) and connect the sensor to the pins specified there.

![ADS1115 16-Bit ADC.](../images/ads1115-full.jpg)
*ADS1115 16-Bit ADC.*
...
- **address** (**Required**, int): The i²c address of the sensor.
  See [I²C Addresses]({{< ref "components/sensor/ads1115#ads1115_i2c_addresses" >}}) for more information.
- **continuous_mode** (*Optional*, boolean): Set if the ADS1115 should continuously measure voltages or
  only measure them when an update is called. Please enable this for the [ct_clamp]({{< ref "ct_clamp/" >}}) component.
  Defaults to `off`.
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this ADS1115 Hub. Use this if you
...
First, setup an [ADS1115 Hub]({{< ref "components/sensor/ads1115#ads1115-component" >}}) for your ADS1115 sensor and then use this
...
![.. code-block:: yaml](../images/ads1115-ui.png)
*.. code-block:: yaml*
...
-  **ads1115_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [ADS1115 Hub]({{< ref "components/sensor/ads1115#ads1115-component" >}}) you want to use this sensor.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ads1115.md)
