...
individual sensors using the [Sensor]({{< ref "components/sensor/ads1115#ads1115-sensor" >}}).
...
- **continuous_mode** (*Optional*, boolean): Set if the ADS1115 should continuously measure voltages or
  ...
  Defaults to `off`.
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this ADS1115 Hub. Use this if you
...
First, setup an [Component/Hub]({{< ref "components/sensor/ads1115#ads1115-component" >}}) for your ADS1115 sensor and then use this
...
{{< img src="ads1115-ui.png" alt="Image" caption=".. code-block:: yaml" width="80.0%" class="center" >}}
...
-  **ads1115_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [Component/Hub]({{< ref "components/sensor/ads1115#ads1115-component" >}}) you want to use this sensor.
