...
- **continuous_mode** (*Optional*, boolean): Set if the ADS1115 should continuously measure voltages or
  ...
  Defaults to `off`.
- **id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID for this ADS1115 Hub. Use this if you
...
-  **ads1115_id** (*Optional*, [ID](guides/configuration-types#config-id)): Manually specify the ID of the
