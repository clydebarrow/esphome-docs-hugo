...
individual sensors using the [ADS1115 Sensor Platform](components/sensor/ads1115#ads1115-sensor).
To use this hub, first setup the [I²C Bus](components/i2c#i2c) and connect the sensor to the pins specified there.
...
- **address** (**Required**, int): The i²c address of the sensor.
  See [I²C Addresses](components/sensor/ads1115#ads1115_i2c_addresses) for more information.
...
First, setup an [ADS1115 Hub](components/sensor/ads1115#ads1115-component) for your ADS1115 sensor and then use this
...
-  **ads1115_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [ADS1115 Hub](components/sensor/ads1115#ads1115-component) you want to use this sensor.
