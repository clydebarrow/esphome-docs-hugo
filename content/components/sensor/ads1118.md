---
description: "ADS1118 4-Channel 16-Bit A/D Converter with Internal Temperature Sensor"
...
individual sensors using the [ADS1118 Sensor Platform]({{< ref "components/sensor/ads1118#ads1118-sensor" >}}).
It uses the [SPI Bus]({{< ref "components/spi#spi" >}}) for communication.

![ADS1118 16-Bit ADC.](../images/ads1118-full.jpg)
*ADS1118 16-Bit ADC.*
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this ADS1118 Hub. Use this if you
...
First, setup an [ADS1118 Hub]({{< ref "components/sensor/ads1118#ads1118-component" >}}) for your ADS1118 sensor and then use this
...
- **ads1118_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [ADS1118 Hub]({{< ref "components/sensor/ads1118#ads1118-component" >}}) you want to use this sensor.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ads1118.md)
