...
individual sensors using the [Sensor]({{< ref "components/sensor/ads1118#ads1118-sensor" >}}).
...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this ADS1118 Hub. Use this if you
...
First, setup an [Component/Hub]({{< ref "components/sensor/ads1118#ads1118-component" >}}) for your ADS1118 sensor and then use this
...
- **ads1118_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [Component/Hub]({{< ref "components/sensor/ads1118#ads1118-component" >}}) you want to use this sensor.
