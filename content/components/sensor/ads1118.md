...
- **id** (*Optional*, [config-id](#config-id)): Manually specify the ID for this ADS1118 Hub. Use this if you
...
- **ads1118_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the
