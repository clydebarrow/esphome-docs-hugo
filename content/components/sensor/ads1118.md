...
individual sensors using the [ADS1118 Sensor Platform](components/sensor/ads1118#ads1118-sensor).
...
First, setup an [ADS1118 Hub](components/sensor/ads1118#ads1118-component) for your ADS1118 sensor and then use this
...
- **ads1118_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
   [ADS1118 Hub](components/sensor/ads1118#ads1118-component) you want to use this sensor.
