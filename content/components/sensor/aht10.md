...
The DHT20 ([datasheet](https://cdn.sparkfun.com/assets/8/a/1/5/0/DHT20.pdf)) sensor has the packaging of the [dht]({{< ref "dht/" >}}) series, but has the AHT20 inside and is speaking [I²C]({{< ref "components/i2c#i2c" >}}) as well.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/sensor/aht10.md)
