...
![Configuration example:](../images/airthings_wave_plus.jpg)
...
![Configuration example:](../images/airthings_wave_mini.jpg)
*Configuration example:*
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/sensor/airthings_ble.md)
