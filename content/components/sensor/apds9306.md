...
- **update_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The interval at which the sensor reading will be updated. Defaults to `60s`.
- All opther options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
