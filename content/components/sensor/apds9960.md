...
![Image by `SparkFun`_.](../images/apds9960-full.jpg)
*Image by `SparkFun`_.*
...
The `apds9960` sensor allows you to use your [apds9960]({{< ref "apds9960/" >}}) to perform different
measurements.
...
The `apds9960` binary sensor allows you to use your [apds9960]({{< ref "apds9960/" >}}) to perform different
measurements.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/apds9960.md)
