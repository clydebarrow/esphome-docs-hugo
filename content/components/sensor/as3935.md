---
description: "AMS AS3935 Franklin Lightning Sensor"
...
![AS3935 Lightning Sensor.](../images/as3935.jpg)
...
- **irq_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The IRQ pin, which indicates if a lightning strike has been detected.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/as3935.md)
