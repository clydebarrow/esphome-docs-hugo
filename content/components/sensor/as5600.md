...
using the [AS5600 Sensor Platform](components/sensor/as5600#as5600-sensor). To use this hub, first setup
the [I²C Bus](components/i2c#i2c) and connect the sensor to the pins specified there.
...
- **dir_pin** (*Optional*, int): The pin connected to the AS5600's direction pin.
  See [Direction](components/sensor/as5600#as5600_direction) for more information.
...
- **start_position** (*Optional*, int): The raw position that should be considered the start (i.e. `0`).
  See [Position / Range](components/sensor/as5600#as5600_position_range).
- **end_position** (*Optional*, int): The raw position that should be considered the end (e.g. 180deg)
  of the allowable rotation range. Mutually exclusive with **range**. See [Position / Range](components/sensor/as5600#as5600_position_range).
- **range** (*Optional*, int): The allowable rotation range from the **start_position**. Mutually
  exclusive with **end_position**. See [Position / Range](components/sensor/as5600#as5600_position_range).
...
- **address** (*Optional*, int): The i²c address of the sensor.
  See [I²C Addresses](components/sensor/as5600#as5600_i2c_addresses) for more information.
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this AS5600 Hub.
- All other options for I²C devices described at [I²C Bus](components/i2c#i2c).
...
First, setup an [AS5600 Hub](components/sensor/as5600#as5600-component) for your AS5600 sensor and then use this
...
- **out_of_range_mode** (*Optional*, string): How to treat out of range values. Only applicable if configured
  for a range less than 360 degrees. Defaults to `min_max`. See [Out of Range Mode](components/sensor/as5600#as5600-out-of-range-mode).
- **as5600_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [AS5600 Hub](components/sensor/as5600#as5600-component) you want to use this sensor.
...
- **status** (*Optional*): Information about the magnet status. Typically for diagnostic purposes.
  See [Magnet Status](components/sensor/as5600#as5600-magnet-status)
