---
description: "AS5600 12-Bit Magnetic Position Sensor"
...
using the [Sensor]({{< ref "components/sensor/as5600#as5600-sensor" >}}). To use this hub, first setup
the [I²C Bus]({{< ref "components/i2c#i2c" >}}) and connect the sensor to the pins specified there.
...
- **dir_pin** (*Optional*, int): The pin connected to the AS5600's direction pin.
  See [Direction]({{< ref "components/sensor/as5600#as5600_direction" >}}) for more information.
...
- **start_position** (*Optional*, int): The raw position that should be considered the start (i.e. `0`).
  See [Position / Range]({{< ref "components/sensor/as5600#as5600_position_range" >}}).
- **end_position** (*Optional*, int): The raw position that should be considered the end (e.g. 180deg)
  of the allowable rotation range. Mutually exclusive with **range**. See [Position / Range]({{< ref "components/sensor/as5600#as5600_position_range" >}}).
- **range** (*Optional*, int): The allowable rotation range from the **start_position**. Mutually
  exclusive with **end_position**. See [Position / Range]({{< ref "components/sensor/as5600#as5600_position_range" >}}).
...
- **address** (*Optional*, int): The i²c address of the sensor.
  See [I²C Addresses]({{< ref "components/sensor/as5600#as5600_i2c_addresses" >}}) for more information.
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this AS5600 Hub.
...
{{< img src="as5600-magnet-position.png" alt="Image" caption="Position and range may be configured as one of the following:" width="80.0%" class="center" >}}
...
First, setup an [Component/Hub]({{< ref "components/sensor/as5600#as5600-component" >}}) for your AS5600 sensor and then use this
sensor platform to create individual sensors that will report the position to Home Assistant.

{{< img src="as5600-ui.jpg" alt="Image" caption=".. code-block:: yaml" width="80.0%" class="center" >}}
...
- **out_of_range_mode** (*Optional*, string): How to treat out of range values. Only applicable if configured
  for a range less than 360 degrees. Defaults to `min_max`. See [Out of Range Mode]({{< ref "components/sensor/as5600#as5600-out-of-range-mode" >}}).
- **as5600_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [Component/Hub]({{< ref "components/sensor/as5600#as5600-component" >}}) you want to use this sensor.
...
- **status** (*Optional*): Information about the magnet status. Typically for diagnostic purposes.
  See [Magnet Status]({{< ref "components/sensor/as5600#as5600-magnet-status" >}})
...
{{< img src="as5600-ui-derived.jpg" alt="Image" caption=".. code-block:: yaml" width="80.0%" class="center" >}}
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/as5600.md)
