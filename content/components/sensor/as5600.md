...
using the [AS5600 Sensor Platform]({{< ref "components/sensor/as5600#as5600-sensor" >}}). To use this hub, first setup
the [I²C Bus]({{< ref "components/i2c#i2c" >}}) and connect the sensor to the pins specified there.

![AS5600 12-Bit Magnetic Position Sensor.](../images/as5600-full.jpg)
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for this AS5600 Hub.
...
![Position and range may be configured as one of the following:](../images/as5600-magnet-position.png)
...
First, setup an [AS5600 Hub]({{< ref "components/sensor/as5600#as5600-component" >}}) for your AS5600 sensor and then use this
sensor platform to create individual sensors that will report the position to Home Assistant.

![.. code-block:: yaml](../images/as5600-ui.jpg)
*.. code-block:: yaml*
...
- **as5600_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the
  [AS5600 Hub]({{< ref "components/sensor/as5600#as5600-component" >}}) you want to use this sensor.
...
![.. code-block:: yaml](../images/as5600-ui-derived.jpg)
*.. code-block:: yaml*
