---
description: "Belling BL0906 Energy Monitor"
...
to have an [UART bus]({{< ref "components/uart#uart" >}}) in your configuration with the `tx_pin` and `rx_pin` connected to the BL0906.
...
![Athom Single Phase 2 channels Real Time Whole House Energy Meter.](../images/athom-em2.png)
...
![Athom Single Phase 6 channels Real Time Whole House Energy Meter.](../images/athom-em6.png)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/bl0906.md)
