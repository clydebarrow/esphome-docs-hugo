...
the sensor returns to sleep mode until next measurement. The [SPI Bus]({{< ref "components/spi#spi" >}}) or [I²C Bus]({{< ref "components/i2c#i2c" >}}) is
required to be set up in your configuration for this sensor to work.

**Note:** In [I²C Bus]({{< ref "components/i2c#i2c" >}}) mode pulling CSB to 3V is recommended, in order to avoid `[E][sensor.bme280:155]: Communication with BME280 failed!` error. See the *Connection diagram* chapter in datasheet above.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/bme280.md)
