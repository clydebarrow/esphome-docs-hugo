...
`Adafruit`_) temperature, pressure and humidity sensors with ESPHome. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) is required to be set up in
...
- **temperature** (*Optional*): The information for the temperature sensor.
  ...
  - **oversampling** (*Optional*): The oversampling parameter for the temperature sensor.
    See [Oversampling Options]({{< ref "components/sensor/bme680#bme680-oversampling" >}}).
...
- **heater** (*Optional*): The settings for the internal heater for the gas sensor. Set this
  ...
  - **temperature** (*Optional*, int): The target temperature of the heater between 200 and 400 °C.
    Defaults to `320`.
  - **duration** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): The duration the heater should be active. Maximum value is `4032ms`.
    Defaults to `150ms`.
