...
`Adafruit`_) temperature and pressure sensors with ESPHome. The [I²C](components/i2c#i2c) or [SPI](components/spi#spi) is
...
- **temperature** (*Optional*): The information for the temperature.
  ...
  - **oversampling** (*Optional*): The oversampling parameter for the temperature sensor.
    See [Oversampling Options](components/sensor/bmp280#bmp280-oversampling).
...
- **cs_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The CS pin of the BMP280 sensor.
