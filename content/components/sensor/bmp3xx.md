...
## Over I²C
The `bmp3xx_i2c` component allows you to use the device over [I²C](components/i2c#i2c) interface.
...
- **temperature** (*Optional*): The information for the temperature sensor.
  ...
  - **oversampling** (*Optional*): The oversampling parameter for the temperature sensor.
    See [Oversampling Options](components/sensor/bmp3xx#bmp3xx-oversampling).
...
## Over SPI
The `bmp3xx_spi` component allows you to use the device over [SPI](components/spi#spi) interface.
