---
description: "BMP581 Temperature+Pressure Sensor"
...
([datasheet](https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bmp581-ds004.pdf), [SparkFun](https://www.sparkfun.com/products/20170)) temperature and pressure sensors with ESPHome. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) bus is
required to be set up in your configuration for this sensor to work.

{{< img src="bmp581.jpg" alt="Image" caption="BMP581 Temperature and Pressure Sensor.(Credit: `SparkFun <https://www.sparkfun.com/products/20170>`__, image cropped and compressed)" width="50.0%" class="center" >}}
...
- **temperature** (*Optional*): The information for the temperature sensor.
  ...
  - **oversampling** (*Optional*): The oversampling rate for the temperature sensor.
    See [Oversampling Options]({{< ref "components/sensor/bmp581#bmp581-oversampling" >}}).
  - **iir_filter** (*Optional*): The Infinite Impulse Response Filter level for the temperature sensor.
    See [Infinite Impule Response Filter Options]({{< ref "components/sensor/bmp581#bmp581-iir" >}}).
...
{{< warning >}}
The BMP581's deep standby mode is disabled when you enable an IIR filter, which increases power consumption. Consider using a mathematically equivalent ESPHome exponential moving average filter instead, especially if you configure a long update interval. See the [exponential moving average filter<sensor-filter-exponential_moving_average>]({{< ref "#exponential moving average filter<sensor-filter-exponential_moving_average>" >}}) for implementation information.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/bmp581.md)
