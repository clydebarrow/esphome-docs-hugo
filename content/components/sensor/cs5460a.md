---
description: "CS5460A Power Sensor"
...
![CS5460A Single-Phase Power/Energy IC module](../../images/cs5460a.png)
...
Your device communicates with the CS5460A over SPI so you need to have an [SPI Bus]({{< ref "components/spi#spi" >}}) in
...
- **current** (*Optional*): The sensor subcomponent that will report RMS current values in Amperes.
  All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).  See note below about throttling.
...
shorter, consider [Sensor Filters]({{< ref "components/sensor/_index#sensor-filters" >}}) the measurements if you have a Home
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/cs5460a.md)
