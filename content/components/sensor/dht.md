...
![DHT22 Temperature & Humidity Sensor.](../images/dht-full.jpg)
...
- **pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin where the DHT bus is connected.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/sensor/dht.md)
