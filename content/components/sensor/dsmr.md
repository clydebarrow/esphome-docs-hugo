...
{{< img src="dsmr-request-pin-circuit-example.png" alt="Image" caption="When using a type of MCU that provides 5V on the GPIO outputs instead of 3.3V, then use a 330 Ohm" >}}
