...
The [SPI Bus]({{< ref "components/spi#spi" >}}) or [I²C Bus]({{< ref "components/i2c#i2c" >}}) is required to be set up in your configuration for this sensor to work.
...
- **compensation** (*Optional*): The block containing sensors used for compensation.
  ...
  - **temperature** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of an external temperature sensor.
  - **humidity** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of an external humidity sensor.
