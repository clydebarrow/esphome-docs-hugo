...
The [I²C](components/i2c#i2c) or [SPI](components/spi#spi) is required to be set up in your configuration for this sensor to work.
...
- **cs_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): *SPI only.* The Chip Select pin.
