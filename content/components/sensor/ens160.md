...
- **compensation** (*Optional*): The block containing sensors used for compensation.
  ...
  - **temperature** (**Required**, [ID](guides/configuration-types#config-id)): The ID of an external temperature sensor.
  - **humidity** (**Required**, [ID](guides/configuration-types#config-id)): The ID of an external humidity sensor.
