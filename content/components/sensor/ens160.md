---
description: "ENS160 Volatile Organic Compound (VOC) and eCO₂ Sensor"
...
The [SPI]({{< ref "components/spi#spi" >}}) or [I²C]({{< ref "components/i2c#i2c" >}}) is required to be set up in your configuration for this sensor to work.
...
{{< /note >}}
![ENS160 Air Quality Sensor.](../images/ens160.jpg)
...
- **cs_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): *SPI only.* The Chip Select pin.
...
- **compensation** (*Optional*): The block containing sensors used for compensation.
  ...
  - **temperature** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of an external temperature sensor.
  - **humidity** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of an external humidity sensor.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ens160.md)
