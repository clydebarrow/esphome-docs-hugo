...
- **compensation** (*Optional*): The block containing sensors used for compensation.
  ...
  - **temperature** (**Required**, [config-id](#config-id)): The ID of an external temperature sensor.
  - **humidity** (**Required**, [config-id](#config-id)): The ID of an external humidity sensor.
