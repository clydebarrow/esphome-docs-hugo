...
The sensor itself will push values every second. You may wish to [Sensor Filters]({{< ref "components/sensor/_index#sensor-filters" >}}) this value to reduce the amount of data you are ingesting.
