...
- **sensor** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ADC sensor to measure the sensor's output voltage pulses from.
...
- **output** (**Required**, [output]({{< ref "components/output/_index#output" >}})): The binary [config-id]({{< ref "guides/configuration-types#config-id" >}}) to control the sensor's internal IR LED.
