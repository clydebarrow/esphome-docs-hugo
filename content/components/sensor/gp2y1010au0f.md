...
- **sensor** (**Required**, [config-id](#config-id)): The ADC sensor to measure the sensor's output voltage pulses from.
...
- **output** (**Required**, [config-id](#config-id)): The binary [output](#output) to control the sensor's internal IR LED.
