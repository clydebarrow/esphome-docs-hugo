...
- **sensor** (**Required**, [ID](guides/configuration-types#config-id)): The ADC sensor to measure the sensor's output voltage pulses from.
...
- **output** (**Required**, [ID](guides/configuration-types#config-id)): The binary [Output Component](components/output/_index#output) to control the sensor's internal IR LED.
