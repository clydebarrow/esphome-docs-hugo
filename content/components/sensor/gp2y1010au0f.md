...
- **output** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The binary [Output Component]({{< ref "components/output/_index#output" >}}) to control the sensor's internal IR LED.
