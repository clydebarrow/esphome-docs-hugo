...
- **cf_pin** (**Required**, [Pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin CF is connected to.
- **cf1_pin** (**Required**, [Pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin CF1 is connected to.
