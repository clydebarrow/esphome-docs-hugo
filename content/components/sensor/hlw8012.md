---
description: "HLW8012 Power Sensor"
...
[CSE7766 ]({{< relref "cse7766/" >}}) component.
...
- **sel_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The pin SEL is connected to.
- **cf_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin CF is connected to.
- **cf1_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin CF1 is connected to.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/hlw8012.md)
