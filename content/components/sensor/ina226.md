---
description: "INA226 DC current and power sensor"
...
![INA226 DC Current and Power Sensor.](../images/ina226-full.jpg)
...
- **adc_time** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}}) or both of the following nested options): The time in microseconds to perform a single ADC conversion.
  Defaults to `1100us`. Valid values are `140us`, `204us`, `332us`, `588us`, `1100us`, `2116us`, 
  `4156us`, `8244us`.

  - **voltage** (**Required**, [config-time]({{< ref "guides/configuration-types#config-time" >}})): ADC conversion time for Bus Voltage
  - **current** (**Required**, [config-time]({{< ref "guides/configuration-types#config-time" >}})): ADC conversion time for Shunt Voltage (Current measurement)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ina226.md)
