...
- **adc_time** (*Optional*, [config-time](#config-time) or both of the following nested options): The time in microseconds to perform a single ADC conversion.
  Defaults to `1100us`. Valid values are `140us`, `204us`, `332us`, `588us`, `1100us`, `2116us`,
  `4156us`, `8244us`.

  - **voltage** (**Required**, [config-time](#config-time)): ADC conversion time for Bus Voltage
  - **current** (**Required**, [config-time](#config-time)): ADC conversion time for Shunt Voltage (Current measurement)
