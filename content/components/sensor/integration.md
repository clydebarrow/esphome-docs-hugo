...
- **sensor** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of the sensor to integrate over time.
...
This [All Actions]({{< ref "automations/actions#config-action" >}}) allows you to reset the value of the integration sensor
