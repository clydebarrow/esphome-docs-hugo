...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for [ld2410]({{< ref "ld2410/" >}})2410` component if you need multiple components.
...
- **out_pin_presence_status** (*Optional*): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), indicates whether the OUT pin indicates presence or not, otherwise `false`.
  ...
  All options from [Base Binary Sensor Configuration]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **ld2410_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for[ld2410]({{< ref "ld2410/" >}})2410` component if you are using multiple components.
...
- **baud_rate** (*Optional*): Control the serial port baud rate. Defaults to `256000`.
  Once changed, all sensors will stop working until a fresh install with an updated [UART Bus]({{< ref "components/uart#uart" >}}) configuration.
  All options from [Base Select Configuration]({{< ref "components/select/_index#config-select" >}}).
...
This is an [All Actions]({{< ref "automations/actions#config-action" >}}) for setting the bluetooth password.
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of[ld2410]({{< ref "ld2410/" >}})2410` component to set.
- **password** (**Required**, string, [Templating Actions]({{< ref "automations/templates#config-templatable" >}})):
