...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for {{< docref "ld2410/" >}}2410` component if you need multiple components.
...
- **out_pin_presence_status** (*Optional*): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), indicates whether the OUT pin indicates presence or not, otherwise `false`.
  ...
  All options from [Base Binary Sensor Configuration]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **ld2410_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for{{< docref "ld2410/" >}}2410` component if you are using multiple components.
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The ID of{{< docref "ld2410/" >}}2410` component to set.
