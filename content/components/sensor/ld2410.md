...
![LD2410 motion and presence sensor](../images/ld2410.jpg)
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for [ld2410]({{< ref "ld2410/" >}})2410` component if you need multiple components.

## Binary Sensor

The `ld2410` binary sensor allows you to use your [ld2410]({{< ref "ld2410/" >}}) to perform different
measurements.
...
- **has_still_target** (*Optional*): If true a still target is detected.
  All options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **out_pin_presence_status** (*Optional*): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), indicates whether the OUT pin indicates presence or not, otherwise `false`.
  OUT pin indication depends on the [light function<ld2410-light-function>]({{< ref "#light function<ld2410-light-function>" >}}) configuration. Might need latest firmware to work.
  All options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **ld2410_id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for[ld2410]({{< ref "ld2410/" >}})2410` component if you are using multiple components.

## Sensor

The `ld2410` sensor allows you to use your [ld2410]({{< ref "ld2410/" >}}) to perform different
measurements.
...
- **light** (*Optional*, int): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), indicates the light sensitivity, otherwise `unknown`.
...
- **gX** (*Optional*): Energies for the Xth gate (X => 0 to 8).
    ...
    - **move_energy** (*Optional*, int): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), the move energy of the gate, otherwise `unknown`.
      Value between `0` and `100` inclusive.
      All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
    - **still_energy** (*Optional*, int): When in [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}), the still energy of the gate, otherwise `unknown`.
      Value between `0` and `100` inclusive.
      All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
...
The `ld2410` switch allows you to control your [ld2410]({{< ref "ld2410/" >}}).
...
The `ld2410` number allows you to control the configuration of your [ld2410]({{< ref "ld2410/" >}}).
...
- **light_threshold** (*Optional*, int): Sets the light threshold for the [light function<ld2410-light-function>]({{< ref "#light function<ld2410-light-function>" >}}).
...
The `ld2410` button allows you to perform actions on your [ld2410]({{< ref "ld2410/" >}}).
...
The `ld2410` text sensor allows you to get information about your [ld2410]({{< ref "ld2410/" >}}).
...
The `ld2410` select allows you to control your [ld2410]({{< ref "ld2410/" >}}).
...
- **baud_rate** (*Optional*): Control the serial port baud rate. Defaults to `256000`.
  Once changed, all sensors will stop working until a fresh install with an updated [UART Component]({{< ref "components/uart#uart" >}}) configuration.
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
- **light_function** (*Optional*): If set, will affect the OUT pin value, based on [light threshold<ld2410-light-threshold>]({{< ref "#light threshold<ld2410-light-threshold>" >}}). Can be `off`, `low` or `above`. Defaults to `off`.
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
...
This is an [Action]({{< ref "automations/actions#config-action" >}}) for setting the bluetooth password.
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of[ld2410]({{< ref "ld2410/" >}})2410` component to set.
- **password** (**Required**, string, [templatable]({{< ref "automations/templates#config-templatable" >}})):
...
In order to monitor the presence indicated by the component, with the [light function<ld2410-light-function>]({{< ref "#light function<ld2410-light-function>" >}}) taken
under account, you can set up a [GPIO Binary Sensor]({{< ref "components/binary_sensor/gpio#gpio-binary-sensor" >}}):
...
1. Enable [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}).
2. Monitor the `gX_move_energy` and `gX_still_energy` [sensors<ld2410-sensors>]({{< ref "#sensors<ld2410-sensors>" >}}).
3. Change the [thresholds<ld2410-number>]({{< ref "#thresholds<ld2410-number>" >}}) and repeat step 2 until satisfaction.
4. Disable [engineering mode<ld2410-engineering-mode>]({{< ref "#engineering mode<ld2410-engineering-mode>" >}}).
...
![See Also](../images/ld2410-card.png)
*See Also*
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ld2410.md)
