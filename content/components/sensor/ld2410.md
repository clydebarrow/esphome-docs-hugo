...
- **has_still_target** (*Optional*): If true a still target is detected.
  All options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **out_pin_presence_status** (*Optional*): When in [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}), indicates whether the OUT pin indicates presence or not, otherwise `false`.
  OUT pin indication depends on the [light function]({{< ref "components/sensor/ld2410#ld2410-light-function" >}}) configuration. Might need latest firmware to work.
  All options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
...
- **light** (*Optional*, int): When in [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}), indicates the light sensitivity, otherwise `unknown`.
...
- **gX** (*Optional*): Energies for the Xth gate (X => 0 to 8).
    ...
    - **move_energy** (*Optional*, int): When in [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}), the move energy of the gate, otherwise `unknown`.
      Value between `0` and `100` inclusive.
      All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
    - **still_energy** (*Optional*, int): When in [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}), the still energy of the gate, otherwise `unknown`.
      Value between `0` and `100` inclusive.
      All options from [Sensor]({{< ref "components/sensor/_index#config-sensor" >}}).
...
- **light_threshold** (*Optional*, int): Sets the light threshold for the [light function]({{< ref "components/sensor/ld2410#ld2410-light-function" >}}).
...
- **baud_rate** (*Optional*): Control the serial port baud rate. Defaults to `256000`.
  ...
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
- **light_function** (*Optional*): If set, will affect the OUT pin value, based on [light threshold]({{< ref "components/sensor/ld2410#ld2410-light-threshold" >}}). Can be `off`, `low` or `above`. Defaults to `off`.
  All options from [Select]({{< ref "components/select/_index#config-select" >}}).
...
In order to monitor the presence indicated by the component, with the [light function]({{< ref "components/sensor/ld2410#ld2410-light-function" >}}) taken
...
1. Enable [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}).
2. Monitor the `gX_move_energy` and `gX_still_energy` [sensors]({{< ref "components/sensor/ld2410#ld2410-sensors" >}}).
3. Change the [thresholds]({{< ref "components/sensor/ld2410#ld2410-number" >}}) and repeat step 2 until satisfaction.
4. Disable [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}).
