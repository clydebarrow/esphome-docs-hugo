...
- **id** (*Optional*, :ref:`config-id`): Manually specify the ID for this {{< docref "ld2410/" >}} component if you need multiple components.
...
- **out_pin_presence_status** (*Optional*): When in [engineering mode]({{< ref "components/sensor/ld2410#ld2410-engineering-mode" >}}), indicates whether the OUT pin indicates presence or not, otherwise `false`.
  ...
  All options from [Binary Sensor]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
- **ld2410_id** (*Optional*, :ref:`config-id`): Manually specify the ID for the {{< docref "ld2410/" >}} component if you are using multiple components.
...
- **id** (**Required**, :ref:`config-id`): The ID of the {{< docref "ld2410/" >}} component to set.
