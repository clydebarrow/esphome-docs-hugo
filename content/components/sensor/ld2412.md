...
{{< img src="ld2412.png" alt="Image" caption="LD2412 motion and presence sensor" width="50.0%" class="center" >}}
...
2. Monitor the `gate_X_move_energy` and `gate_X_still_energy` [sensors](#ld2412-sensors).
3. Change the [thresholds](#ld2412-number) and repeat step 2 until you are satisfied.
4. Disable [engineering mode](#ld2412-engineering-mode).
