...
can use the [HLKRadarTool mobile app]({{< ref "components/sensor/ld2450#ld2450-mobile-apps" >}}) to update the firmware.
...
- **zone_N** (*Optional*): Target count details in the defined [zones]({{< ref "components/sensor/ld2450#ld2450-number" >}}) (N = 1 to 3). A maximum of
...
- **presence_timeout** (**Required**, int): The duration, in seconds, for which the
  [presence states]({{< ref "components/sensor/ld2450#ld2450-binary-sensors" >}}) will persist even after the detection is cleared. Default is `5`
