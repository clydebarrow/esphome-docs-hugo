...
- **id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for {{< docref "ld2450/" >}}2450` component.
...
- **ld2450_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for{{< docref "ld2450/" >}}2450` component.
...
- **ld2450_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID for{{< docref "ld2450/" >}}2450` component if you are
