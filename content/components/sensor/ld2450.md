...
- **id** (*Optional*, [config-id](#config-id)): Manually specify the ID for this {{< docref "ld2450/" >}} component.
- **uart_id** (*Optional*, [config-id](#config-id)): Manually specify the ID of the [UART Component](#uart) to use.
...
- **ld2450_id** (*Optional*, [config-id](#config-id)): Manually specify the ID for the {{< docref "ld2450/" >}} component.
...
- **ld2450_id** (*Optional*, [config-id](#config-id)): Manually specify the ID for the {{< docref "ld2450/" >}} component if you are
