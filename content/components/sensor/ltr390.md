...
- **uv_index** (*Optional*): UV index (UVI). All options from [Sensor](components/sensor/_index#config-sensor).
- **uv** (*Optional*): Sensor counts for the UV sensor (#). All options from [Sensor](components/sensor/_index#config-sensor).
- **light** (*Optional*): Lux of ambient light (lx). All options from [Sensor](components/sensor/_index#config-sensor).
- **ambient_light** (*Optional*): Sensor counts for the Ambient light sensor (#). All options from [Sensor](components/sensor/_index#config-sensor).
