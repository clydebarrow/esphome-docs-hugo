---
description: "LTR390 UV and Ambient Light Sensor"
...
{{< img src="ltr390-full.jpg" alt="Image" caption=".. _Adafruit: https://www.adafruit.com/product/4831" width="80.0%" class="center" >}}
...
- **uv_index** (*Optional*): UV index (UVI). All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **uv** (*Optional*): Sensor counts for the UV sensor (#). All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **light** (*Optional*): Lux of ambient light (lx). All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
- **ambient_light** (*Optional*): Sensor counts for the Ambient light sensor (#). All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
...
- [/components/sensor/bh1750]({{< ref "/components/sensor/bh1750" >}})
- [/components/sensor/tsl2561]({{< ref "/components/sensor/tsl2561" >}})
- [TEMT6000](https://devices.esphome.io/devices/temt6000)
- [Sensor Filters]({{< ref "components/sensor/_index#sensor-filters" >}})
- :apiref:`ltr390/ltr390.h`
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ltr390.md)
