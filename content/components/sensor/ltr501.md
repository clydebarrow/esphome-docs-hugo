...
The sensors are very similar and share the same datasheet. The [I²C Bus](components/i2c#i2c) is required to be set up in your
...
[Olimex](https://www.olimex.com/Products/Modules/Sensors/MOD-LTR-501ALS/open-source-hardware)
