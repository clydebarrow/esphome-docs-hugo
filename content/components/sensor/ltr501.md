...
![LTR-501 on a breadboard from Olimex](../images/ltr501-full.jpg)
*LTR-501 on a breadboard from Olimex*


![LTR-501 Sensor in Home Assistant UI.](../images/ltr501-ui.png)
...
The sensors are very similar and share the same datasheet. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) is required to be set up in your
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/ltr501.md)
