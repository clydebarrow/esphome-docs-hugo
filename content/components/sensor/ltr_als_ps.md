...
- **integration_time** (*Optional*, [Time](guides/configuration-types#config-time)):
...
- **update_interval** (*Optional*, [Time](guides/configuration-types#config-time)): The interval for checking the sensors.
  Defaults to `60s`.
- **ps_cooldown** (*Optional*, [Time](guides/configuration-types#config-time)): The "cooldown" period after the proximity sensor is triggered.
