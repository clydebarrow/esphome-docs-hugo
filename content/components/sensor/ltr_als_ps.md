...
- **integration_time** (*Optional*, [config-time](#config-time)):
...
- **update_interval** (*Optional*, [config-time](#config-time)): The interval for checking the sensors.
  Defaults to `60s`.
- **ps_cooldown** (*Optional*, [config-time](#config-time)): The "cooldown" period after the proximity sensor is triggered.
