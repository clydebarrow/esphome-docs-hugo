---
description: "Analog Devices MAX17043 battery fuel gauge"
...
`DFRobot`_) in ESPHome. It uses the [I²C Bus]({{< ref "components/i2c#i2c" >}}) for communication (the address is fixed at 0x36).
...
{{< /note >}}
![DFRobot DFR0563 Gravity I2C 3.7V Li battery fuel gauge.](../images/max17043.jpg)
...
- [/components/deep_sleep]({{< ref "/components/deep_sleep" >}})
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/max17043.md)
