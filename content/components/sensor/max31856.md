...
to have an [spi bus]({{< ref "components/spi#spi" >}}) in your configuration with both **miso_pin** and **mosi_pin** set.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/max31856.md)
