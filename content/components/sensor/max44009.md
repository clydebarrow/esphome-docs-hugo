---
description: "MAX44009 Ambient Light Sensor"
...
from 0.045 lux to 188,000 lux. The [I²C bus]({{< ref "components/i2c#i2c" >}}) is required to be set up in your
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/max44009.md)
