---
description: "MCP3008 8-Channel 10-Bit A/D Converter"
...
{{< img src="mcp3008.jpg" alt="Image" caption=".. _mcp3008-component:" width="50.0%" class="center" >}}
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this MCP3008 component.
...
First, setup a [Component/Hub]({{< ref "components/sensor/mcp3008#mcp3008-component" >}}) for your MCP3008 sensor and then use this
sensor platform to create individual sensors that will report the voltage to Home Assistant.

Configuration variables:

- **mcp3008_id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the parent MCP3008 component.
- **number** (**Required**, int): The pin number of the MCP3008.
- **reference_voltage** (*Optional*, float): The reference voltage. Defaults to `3.3V`.
- **update_interval** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): The interval to check the sensor. Defaults to `1s`.

## See Also

- [SPI Bus]({{< ref "components/spi#spi" >}})
- :apiref:`mcp3008/mcp3008.h`
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/mcp3008.md)
