...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this MCP3008 component.
...
- **mcp3008_id** (**Required**, [ID](guides/configuration-types#config-id)): The id of the parent MCP3008 component.
- **number** (**Required**, int): The pin number of the MCP3008.
- **reference_voltage** (*Optional*, float): The reference voltage. Defaults to `3.3V`.
- **update_interval** (*Optional*, [Time](guides/configuration-types#config-time)): The interval to check the sensor. Defaults to `1s`.
