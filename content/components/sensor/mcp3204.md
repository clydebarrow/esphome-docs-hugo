...
- **cs_pin** (**Required**, [Pin Schema](guides/configuration-types#config-pin_schema)): The SPI cable select pin to use.
...
First, setup a [MCP3204 Hub](components/sensor/mcp3204#mcp3204-component) for your MCP3204/8 sensor and then use this
