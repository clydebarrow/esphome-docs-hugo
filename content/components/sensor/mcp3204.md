...
![.. _mcp3204-component:](../images/mcp3204.jpg)
*.. _mcp3204-component:*
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this MCP3204 component.
...
First, setup a [MCP3204 Hub]({{< ref "components/sensor/mcp3204#mcp3204-component" >}}) for your MCP3204/8 sensor and then use this
...
- **mcp3204_id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the parent MCP3204 component.
