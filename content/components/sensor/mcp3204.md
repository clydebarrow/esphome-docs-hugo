...
- **id** (**Required**, [config-id](#config-id)): The id to use for this MCP3204 component.
...
- **mcp3204_id** (**Required**, [config-id](#config-id)): The id of the parent MCP3204 component.
