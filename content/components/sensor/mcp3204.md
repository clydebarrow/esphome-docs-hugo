---
description: "MCP3204 & MCP3208 12-Bit A/D Converters"
...
{{< img src="mcp3204.jpg" alt="Image" caption=".. _mcp3204-component:" width="50.0%" class="center" >}}
...
- **id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this MCP3204 component.
- **cs_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The SPI cable select pin to use.
...
First, setup a [Component/Hub]({{< ref "components/sensor/mcp3204#mcp3204-component" >}}) for your MCP3204/8 sensor and then use this
...
- **mcp3204_id** (**Required**, [ID]({{< ref "guides/configuration-types#config-id" >}})): The id of the parent MCP3204 component.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/mcp3204.md)
