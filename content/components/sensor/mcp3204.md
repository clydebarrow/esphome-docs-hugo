...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this MCP3204 component.
...
- **mcp3204_id** (**Required**, [ID](guides/configuration-types#config-id)): The id of the parent MCP3204 component.
