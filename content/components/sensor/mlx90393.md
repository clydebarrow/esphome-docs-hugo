...
`Adafruit`_) three axis magnetometer with ESPHome. The [I²C](components/i2c#i2c) is required to be set up in
...
- **drdy_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): Data-ready pin. Often labelled `INT`. Using this pin might lead to slightly quicker read times.
