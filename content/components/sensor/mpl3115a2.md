...
`Adafruit`_)  temperature and pressure sensors with ESPHome. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) is
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/mpl3115a2.md)
