...
![MS8607 Temperature, Pressure & Humidity Sensor. Image by `Adafruit`_](../images/ms8607-full.jpg)
...
- **humidity** (*Optional*): The information for the humidity sensor.
  ...
  - **i2c_id** (*Optional*, [I²C Component]({{< ref "components/i2c#i2c" >}})): Manually specify the ID of the [config-id]({{< ref "guides/configuration-types#config-id" >}}) if your
