...
![Module breakout board with MSA311 sensor.](../images/msa311-full.jpg)
*Module breakout board with MSA311 sensor.*


![Example of MSA3xx sensor representation in ESPHome dashboard.](../images/msa3xx-ui.png)
...
For every sensor **name** is required. All other options from [Base Binary Sensor Configuration]({{< ref "components/binary_sensor/_index#config-binary_sensor" >}}).
...
regular notation only the **name** is required. All options from [Base Sensor Configuration]({{< ref "components/sensor/_index#config-sensor" >}}).
