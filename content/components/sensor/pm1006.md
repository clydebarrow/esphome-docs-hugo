...
As the communication with the PM1006 is done using UART, you need to have an [UART bus](components/uart#uart) in your configuration with the `rx_pin` connected to the TX pin of the PM1006.
