...
- **internal_filter** (*Optional*, [Time](guides/configuration-types#config-time)): If a pulse shorter than this
...
of “pulses/min”. You can change this by using [Sensor Filters](components/sensor/_index#sensor-filters).
