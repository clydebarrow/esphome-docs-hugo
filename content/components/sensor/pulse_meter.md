...
{{< img src="pulse-counter_vs_pulse-meter.png" alt="Image" caption="Please note that it is not possible to use both of these two sensors on the same pin at the same time." width="50.0%" class="center" >}}
