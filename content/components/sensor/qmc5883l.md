---
description: "QMC5883L Magnetometer"
...
ESPHome. This sensor is very simular to the [HMC5883L Magnetometer]({{< ref "components/sensor/hmc5883l#hmc5883l" >}}) sensor and is oftern found
as a knock off replacement. The QMC5883L sensor performs on par to the HMC5883L sensor,
though the configuration differs. The [I²C Bus]({{< ref "components/i2c#i2c" >}}) is required to be set up in your
configuration for this sensor to work.

![QMC5883L Magnetometer.](../../images/qmc5883l.jpg)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/qmc5883l.md)
