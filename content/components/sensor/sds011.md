---
description: "SDS011 Particulate Matter Sensor"
...
![SDS011 Particulate Matter Sensor](../images/sds011-full.jpg)
...
- **update_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The interval to check the sensor in minutes.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/sds011.md)
