---
description: "SM300D2 7-in-1 Air Quality Sensor"
...
![SM300D2 7-in-1 Air Quality Sensor.](../images/sm300d2-full.jpg)
*SM300D2 7-in-1 Air Quality Sensor.*


![Although the SM300D2 sensor supports connections via UART or RS485, this platform only supports UART](../images/sm300d2-ui.png)
...
[note below]({{< ref "components/sensor/sm300d2#pins-note" >}}) regarding powering everything).

Make sure you have a [UART bus]({{< ref "components/uart#uart" >}}) in your configuration with the `rx_pin` connected to the
...
![Pins on the SM300D2. UART RX is not in use.](../images/sm300d2-pins.jpg)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/sm300d2.md)
