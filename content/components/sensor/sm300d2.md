...
{{< img src="sm300d2-ui.png" alt="Image" caption="Although the SM300D2 sensor supports connections via UART or RS485, this platform only supports UART" width="50.0%" class="center" >}}
