...
[note below](components/sensor/sm300d2#pins-note) regarding powering everything).

Make sure you have a [UART bus](components/uart#uart) in your configuration with the `rx_pin` connected to the
