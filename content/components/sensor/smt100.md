...
![The communication with this component is done via a :ref:`UART <uart>` using a simple ASCII protocol. You must](../images/smt100.jpg)
...
- **update_interval** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The interval to poll the sensor. Defaults is 60s.
