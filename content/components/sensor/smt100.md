---
description: "SMT100 Soil Moisture Sensor"
...
{{< img src="smt100.jpg" alt="Image" caption="The communication with this component is done via a :ref:`UART <uart>` using a simple ASCII protocol. You must" width="50.0%" class="center" >}}
...
- **update_interval** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): The interval to poll the sensor. Defaults is 60s.

## See Also

- [/components/sensor/smt100]({{< ref "/components/sensor/smt100" >}})
- [Sensor Filters]({{< ref "components/sensor/_index#sensor-filters" >}})
- :apiref:`smt100/smt100.h`
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/smt100.md)
