---
description: "TMP1075 Temperature Sensor"
...
{{< img src="tmp1075.jpg" alt="Image" caption="TMP1075 Temperature Sensor.(Credit: `Texas Instruments <https://www.ti.com/content/dam/ticom/images/products/ic/sensing-products/chips/tmp1075-technical-chip-shot.png>`__, image cropped and compressed)" width="30.0%" class="center" >}}
...
To use the sensor, first set up an [I²C Bus]({{< ref "components/i2c#i2c" >}}) and connect the sensor
...
- **address** (*Optional*, int): The I²C address of the sensor.
  See [I²C Addresses]({{< ref "components/sensor/tmp1075#tmp1075_i2c_addresses" >}}) for more information. Defaults to `0x48`.
