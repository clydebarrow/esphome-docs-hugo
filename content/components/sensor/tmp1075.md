...
To use the sensor, first set up an [I²C Bus](components/i2c#i2c) and connect the sensor
...
- **address** (*Optional*, int): The I²C address of the sensor.
  See [I²C Addresses](components/sensor/tmp1075#tmp1075_i2c_addresses) for more information. Defaults to `0x48`.
