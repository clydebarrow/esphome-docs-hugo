---
description: "TMP117 Temperature Sensor"
...
{{< img src="tmp117.jpg" alt="Image" caption="TMP117 Temperature Sensor.(Credit: `Sparkfun <https://www.sparkfun.com/products/15805>`__, image cropped and compressed)" width="30.0%" class="center" >}}
...
- **update_interval** (*Optional*, [Time]({{< ref "guides/configuration-types#config-time" >}})): The interval to check the sensor. Defaults to `60s`.  The sensor component sets the maximum possible averaging in the sensor based on this.
