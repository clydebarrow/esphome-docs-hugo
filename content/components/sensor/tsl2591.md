...
Communication with the device is over [I²C](components/i2c#i2c), which must be present in your configuration.

The TSL2591 device is available on breakout boards from a few vendors
(for example, `Adafruit`_, `CQRobot`_, `Waveshare`_).

[Adafruit](http://www.adafruit.com/products/1980)
[CQRobot](https://www.cqrobot.com/index.php?route=product/product&product_id=1112)
[Waveshare](https://www.waveshare.net/shop/TSL25911-Light-Sensor.htm)
