---
description: "TX20/TX23 Wind Speed/Direction Sensor"
...
![TX20 / TX23 Wind Speed / Direction.](../images/tx20.jpg)
...
- **pin** (**Required**, [Pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin, where the black or brown
  cable are connected.
...
There are various alternatives though, and since ESPHome has a [/components/modbus]({{< ref "/components/modbus" >}}), any model supporting RS485 connection
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/tx20.md)
