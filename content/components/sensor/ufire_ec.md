...
![.. code-block:: yaml](../images/ufire_ec.png)
*.. code-block:: yaml*
...
- **temperature_sensor** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): Set the ID of the temperature
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The ID of the ufire EC sensor.
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/sensor/ufire_ec.md)
