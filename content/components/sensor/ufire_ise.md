...
- **ph** (*Optional*, [Sensor](components/sensor/_index#config-sensor)): Set the pH sensor configuration. All options from [Sensor](components/sensor/_index#config-sensor).
