...
![.. code-block:: yaml](../images/ufire_ise.png)
*.. code-block:: yaml*
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/sensor/ufire_ise.md)
