---
description: "VEML3235 Ambient Light Sensor"
...
![The VEML3235 Ambient Light Sensor](../images/veml3235.jpg)
...
- **integration_time** (*Optional*, [config-time]({{< ref "guides/configuration-types#config-time" >}})): The time the device will use for each measurement. Longer
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/veml3235.md)
