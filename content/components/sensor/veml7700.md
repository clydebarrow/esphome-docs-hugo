---
description: "VEML7700 and VEML6030 Ambient Light Sensors"
...
Communication with the device is over [I²C]({{< ref "components/i2c#i2c" >}}), which must be present in your configuration. VEML7700 and VEML6030
...
![VEML7700 Ambient Light Sensor on a board and standalone sensors.](../images/veml7700-full.jpg)
*VEML7700 Ambient Light Sensor on a board and standalone sensors.*


![VEML sensor in Home Assistant UI.](../images/veml7700-ui.png)
...
![ALS and WHITE channels spectral response](../images/veml7700-spectral.png)
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/sensor/veml7700.md)
