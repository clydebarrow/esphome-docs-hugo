...
- **timeout** (*Optional*, [config-time](#config-time)): Sensor setup timeout. Default to `10ms`.
- **timing_budget** (*Optional*, [config-time](#config-time)): Set the timing budget the sensor will use for a single range measurement.
