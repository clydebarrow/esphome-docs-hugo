...
![ZyAura ZGm053U CO2 & Temperature Monitor.](../images/zgm053-full.jpg)
*ZyAura ZGm053U CO2 & Temperature Monitor.*


![ZyAura ZGm053U connection diagram (1 - empty, 2 - clock, 3 - data, 4 - GND). In some other models the clock and data pins are swapped.](../images/zgm053-connection.jpg)
...
- **clock_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin where the clock bus is connected.
- **data_pin** (**Required**, [config-pin]({{< ref "guides/configuration-types#config-pin" >}})): The pin where the data bus is connected.
