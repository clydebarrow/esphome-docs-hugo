...
- **on_sms_received** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An action to be
  performed when an SMS is received. See [sim800l-on_sms_received]({{< ref "components/sim800l#sim800l-on_sms_received" >}}).
- **on_incoming_call** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An action to be
  performed when a call is received. See [sim800l-on_incoming_call]({{< ref "components/sim800l#sim800l-on_incoming_call" >}}).
