...
- **id** (**Required**, [config-id](#config-id)): The id to use for this SN74HC165 component.
...
```
- **sn74hc165** (**Required**, [config-id](#config-id)): The id of the SN74HC165 component of the pin.
