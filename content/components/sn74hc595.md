...
- **id** (**Required**, [config-id](#config-id)): The id to use for this SN74HC595 component.
...
```
- **sn74hc595** (**Required**, [config-id](#config-id)): The id of the SN74HC595 component of the pin.
