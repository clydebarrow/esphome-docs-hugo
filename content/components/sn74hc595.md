...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this SN74HC595 component.
...
```
- **sn74hc595** (**Required**, [ID](guides/configuration-types#config-id)): The id of the SN74HC595 component of the pin.
