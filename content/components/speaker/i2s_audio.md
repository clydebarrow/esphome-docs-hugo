...
- **i2s_audio_id** (*Optional*, [I²S Audio]({{< ref "components/i2s_audio#i2s_audio" >}})): The ID of the [ID]({{< ref "guides/configuration-types#config-id" >}}) you wish to use for this speaker.
