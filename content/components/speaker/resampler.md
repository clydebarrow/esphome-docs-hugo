...
- **buffer_duration** (*Optional*, [Time](guides/configuration-types#config-time)): The duration of the internal ring buffer. Larger values may reduce stuttering but use more memory. Defaults to `500ms`.
