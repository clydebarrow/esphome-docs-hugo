...
The `factory_reset` switch allows you to remotely invalidate (reset) all ESPHome [Adjusting flash writes]({{< ref "components/esphome#preferences-flash_write_interval" >}}) stored in flash memory and reboot your node.
