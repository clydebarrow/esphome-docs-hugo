...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this SX1509 component.
...
```
- **sx1509** (**Required**, [ID](guides/configuration-types#config-id)): The id of the SX1509 component of the pin.
