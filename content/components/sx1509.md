...
`SparkFun`_) in ESPHome. It uses [I²C Bus](components/i2c#i2c) for communication.
...
Any option accepting a [Pin Schema](guides/configuration-types#config-pin_schema) can theoretically be used, but some more
