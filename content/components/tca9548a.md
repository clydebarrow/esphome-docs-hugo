...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this TCA9548A component.
...
- **channels** (*Optional*): The I²C Bus Channels
  ...
  - **bus_id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this virtual I2C Bus.
