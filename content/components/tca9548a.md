...
![tca9548a I2C Multiplexer.](../images/tca9548a.jpg)
...
- **id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this TCA9548A component.
...
- **channels** (*Optional*): The I²C Bus Channels
  ...
  - **bus_id** (**Required**, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id to use for this virtual I2C Bus.
