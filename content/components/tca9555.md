...
- **id** (**Required**, [config-id](#config-id)): The id to use for this TCA9555 component.
- **address** (*Optional*, int): The I²C address of the driver.
  Defaults to `0x21`.

## Pin configuration variables:

- **TCA9555** (**Required**, [config-id](#config-id)): The id of the TCA9555 component of the pin.
