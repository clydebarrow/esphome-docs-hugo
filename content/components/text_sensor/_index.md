...
Text sensors are a lot like normal [sensors ]({{< relref "/components/sensor/index" >}}).
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/components/text_sensor/index.md)
