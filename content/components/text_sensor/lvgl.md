...
Supported widgets are [lvgl-widget-label](#lvgl-widget-label) and [lvgl-widget-textarea](#lvgl-widget-textarea). A single text sensor supports only a single widget; in other words, it's not possible to have multiple widgets associated with a single ESPHome text sensor component.
