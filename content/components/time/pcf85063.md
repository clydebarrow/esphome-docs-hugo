...
This [All Actions]({{< ref "automations/actions#config-action" >}}) triggers a synchronization of the current system time to the RTC hardware.
...
This [All Actions]({{< ref "automations/actions#config-action" >}}) triggers a synchronization of the current system time from the RTC hardware.
