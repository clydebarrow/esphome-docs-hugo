...
You first need to set up the [I2C ]({{< relref "/components/i2c" >}}) component.
...
This [Action]({{< ref "automations/actions#config-action" >}}) triggers a synchronization of the current system time to the RTC hardware.
...
This [Action]({{< ref "automations/actions#config-action" >}}) triggers a synchronization of the current system time from the RTC hardware.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/time/pcf85063.md)
