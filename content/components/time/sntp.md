...
- All other options from [base_time_config](#base_time_config).

{{< note >}}
If your are using [wifi-manual_ip](#wifi-manual_ip) make sure to configure a DNS Server (dns1, dns2) or use only IP addresses for the NTP servers.
