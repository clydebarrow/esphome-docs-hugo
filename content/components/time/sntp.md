...
- All other options from [Base Time Configuration](components/time/_index#base_time_config).

{{< note >}}
If your are using [Manual IPs](components/wifi#wifi-manual_ip) make sure to configure a DNS Server (dns1, dns2) or use only IP addresses for the NTP servers.
