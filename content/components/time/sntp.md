...
- All other options from [base_time_config]({{< ref "components/time/_index#base_time_config" >}}).
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/time/sntp.md)
