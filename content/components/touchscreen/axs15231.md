...
An [I²C Bus]({{< ref "components/i2c#i2c" >}}) bus is required to be set up in your configuration for this touchscreen to work.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/touchscreen/axs15231.md)
