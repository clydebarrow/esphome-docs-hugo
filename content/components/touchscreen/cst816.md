---
description: "cst816 Touch Screen Controller"
...
![cst816t touchscreen on T-Display S3 AMOLED](../images/cst816.jpg)
...
- **reset_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The chip reset pin.
...
the cst816 can report touches on a dedicated button outside the display area. This can be utilised by configuring a [Binary Sensor]({{< ref "components/touchscreen/_index#touchscreen_binary_sensor" >}})
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/touchscreen/cst816.md)
