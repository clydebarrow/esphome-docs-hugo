...
the cst816 can report touches on a dedicated button outside the display area. This can be utilised by configuring a [touchscreen binary sensor]({{< ref "components/touchscreen/_index#touchscreen_binary_sensor" >}})
