---
description: "TT21100 Touch Screen Controller"
...
![TT21100 touchscreen on ESP32-S3-BOX](../images/esp32-s3-box.png)
*TT21100 touchscreen on ESP32-S3-BOX*


![TT21100 touchscreen on ESP32-S3-Korvo-2](../images/esp32-s3-korvo-2.png)
...
- **interrupt_pin** (**Required**, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The touch detection pin.
...
In addition to touch areas on the screen configured through the [Base Touchscreen Configuration]({{< ref "components/touchscreen/_index#config-touchscreen" >}}) component,
...
- **tt21100_id** (*Optional*, [ID]({{< ref "guides/configuration-types#config-id" >}})): Manually specify the ID of the touchscreen.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/touchscreen/tt21100.md)
