...
The [SPI](components/spi#spi) is required to be set up in your configuration for this sensor to work.
...
- **cs_pin** (*Optional*, [Pin Schema](guides/configuration-types#config-pin_schema)): The chip select pin.
