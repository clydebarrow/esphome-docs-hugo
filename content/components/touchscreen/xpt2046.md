---
description: "XPT2046 Touch Screen Controller (Updated version)"
...
The [SPI]({{< ref "components/spi#spi" >}}) is required to be set up in your configuration for this sensor to work.

![XPT2046 Touch Screen Controller](../images/xpt2046-full.jpg)
...
- **cs_pin** (*Optional*, [Pin Schema]({{< ref "guides/configuration-types#config-pin_schema" >}})): The chip select pin.
...
- [Edit this page on GitHub](https://github.com/clydebarrow/esphome-docs-hugo/blob/current/content/components/touchscreen/xpt2046.md)
