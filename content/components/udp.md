...
In conjunction with the [packet-transport]({{< ref "components/packet_transport/_index#packet-transport" >}}) it can be used to broadcast sensor data.
...
- **id** (*Optional*, [config-id]({{< ref "guides/configuration-types#config-id" >}})): The id of the UDP component to use. If there is only one UDP component, this can be omitted.
...
See the [packet-transport]({{< ref "components/packet_transport/_index#packet-transport" >}}) for examples of how to use this component.
...
- [/components/packet_transport/udp]({{< ref "/components/packet_transport/udp" >}})
