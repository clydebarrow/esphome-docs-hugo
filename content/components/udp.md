...
In conjunction with the [packet-transport](#packet-transport) it can be used to broadcast sensor data.
...
- **id** (*Optional*, [config-id](#config-id)): The id of the UDP component to use. If there is only one UDP component, this can be omitted.
...
See the [packet-transport](#packet-transport) for examples of how to use this component.
