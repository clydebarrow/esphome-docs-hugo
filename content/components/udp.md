...
In conjunction with the [Packet Transport Component](components/packet_transport/_index#packet-transport) it can be used to broadcast sensor data.
...
- **data** (**Required**, [templatable](automations/templates#config-templatable), string or list of bytes): The data to write to the UDP port.
...
See the [Packet Transport Component](components/packet_transport/_index#packet-transport) for examples of how to use this component.
