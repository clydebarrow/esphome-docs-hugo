...
![S20-ID keypad and tag reader](../images/wiegand.jpg)
...
- **on_key** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
...
- **on_raw** (*Optional*, [Automation]({{< ref "automations/_index#automation" >}})): An automation to perform
