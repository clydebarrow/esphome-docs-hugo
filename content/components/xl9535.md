...
- **id** (**Required**, [ID](guides/configuration-types#config-id)): The id to use for this `xl9535` component.
...
- **xl9535** (**Required**, [ID](guides/configuration-types#config-id)): The id of the `xl9535` component of the pin.
