...
The {{< docref "/components/sensor/bme280" >}} is a simple temperature, humidity, and pressure sensor with communication over [I²C]({{< ref "components/i2c#i2c" >}}) or [SPI]({{< ref "components/spi#spi" >}}).
