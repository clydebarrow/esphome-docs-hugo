...
The [/components/sensor/bme280]({{< ref "/components/sensor/bme280" >}}) is a simple temperature, humidity, and pressure sensor with communication over [SPI]({{< ref "components/spi#spi" >}}) or [I²C]({{< ref "components/i2c#i2c" >}}).
...
![The first step is to connect the sensor as described :doc:`here </components/sensor/bme280>`.](../images/bme280-header.jpg)
...
- [Edit this page on GitHub](https://github.com/esphome/esphome-docs/blob/current/content/cookbook/bme280_environment.md)
