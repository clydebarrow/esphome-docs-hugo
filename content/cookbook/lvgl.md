...
The easiest way to integrate an LVGL [Automation]({{< ref "automations/_index#automation" >}}) widget and a switch or light is with [``switch``]({{< ref "components/lvgl/widgets#lvgl-widget-switch" >}}): 
...
```
For this example to appear correctly, use the theme and style options from [Fonts]({{< ref "components/lvgl/_index#lvgl-fonts" >}}) and LVGL's own library [Theme and style definitions]({{< ref "cookbook/lvgl#lvgl-cookbook-theme" >}}).
...
```
For this example to work, use the theme and style options from [Theme and style definitions]({{< ref "cookbook/lvgl#lvgl-cookbook-theme" >}}).
...
To have an animation illustrating a battery charging, you can use [Images]({{< ref "components/image#display-image" >}}) with a set of [``animimg``]({{< ref "components/lvgl/widgets#lvgl-widget-animimg" >}}) showing battery levels:
