...
See [mqtt-using_with_home_assistant_entities](#mqtt-using_with_home_assistant_entities).
...
for SSL MQTT connections. See [mqtt-ssl_fingerprints](#mqtt-ssl_fingerprints).
