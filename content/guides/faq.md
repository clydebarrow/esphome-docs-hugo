...
- If you're using the [ESPHome Device Builder](guides/getting_started_hassio#installing-esphome-device-builder), you can use its "Manual
...
2. On some boards, you may need to force the microcontroller into its [programming mode](guides/physical_device_connection#esphome-phy-con-prg).
...
- [ESPHome Web](https://web.esphome.io/), our web-based installer. This is the easiest approach but requires a
    ...
    sure it's detected as a [serial port](guides/physical_device_connection#esphome-phy-con-drv) and click **Connect**. If prompted, allow your
...
- Because status detection in the [ESPHome Device Builder](guides/getting_started_hassio#installing-esphome-device-builder) uses mDNS by
  ...
  node instead. See the [notes in the Docker Reference section](guides/faq#docker-reference-notes) for more information.
