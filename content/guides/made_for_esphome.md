...
- All components/platforms used must have an `id` specified so users can easily refer to,
  [Extend]({{< ref "components/packages#config-packages_extend" >}}) and/or [Remove]({{< ref "components/packages#config-packages_remove" >}}) configuration variables should they choose to
  "take control"
