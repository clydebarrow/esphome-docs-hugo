...
![Example payload of the event source API.](/web-api/event-source.png)
...
To confirm the `<id>` to use, you can set the [Log Levels]({{< ref "components/logger#logger-log_levels" >}})
